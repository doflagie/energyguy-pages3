...
**Document Number:** TM-FRAME-LOOP-001 Rev A
**Equipment:** FRAME LOOP ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | frame loop |
| **Design approach** | Large square loop, low radiation angle (NVIS) |
...
**Operating Principle:**
Large square loop, low radiation angle (NVIS)

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: 10–20 ft sides, high Q, tuned with series capacitor
...
**Model file:** frame_loop.nec

**To simulate (4nec2):**
```bash
4nec2 frame_loop.nec &
```
...
1. frame_loop_antenna_layout.png — Overall antenna layout
2. frame_loop_circuit_schematic.png — Feed network and matching
3. frame_loop_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **frame_loop.nec** file for complete NEC2 electromagnetic model.

---

**End of frame loop Technical Specification**
