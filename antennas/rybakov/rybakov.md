...
**Document Number:** TM-RYBAKOV-001 Rev A
**Equipment:** RYBAKOV ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | Rybakov |
| **Design approach** | End-fed VHF array, folded dipole variant |
...
**Operating Principle:**
End-fed VHF array, folded dipole variant

**Physical Design:**
• Compaction: 30% of full-size
• Special parameters: 2 elements, 30cm spacing, 50Ω feed
...
1. rybakov_antenna_layout.png — Overall antenna layout
2. rybakov_circuit_schematic.png — Feed network and matching
3. rybakov_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **rybakov.nec** file for complete NEC2 electromagnetic model.

---

**End of Rybakov Technical Specification**
