...
**Document Number:** TM-CUBICAL-QUAD-001 Rev A
**Equipment:** CUBICAL QUAD ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | cubical quad |
| **Design approach** | Square loop radiator with reflector, directional |
| **Frequency bands** | 40M, 20M, 15M |
| **Compaction factor** | 0% |
...
**Operating Principle:**
Square loop radiator with reflector, directional

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: Full-size quad, 10–15 dBi gain, 2–3 element
...
**Model file:** cubical_quad.nec

**To simulate (4nec2 on Linux):**
```bash
4nec2 cubical_quad.nec &
```
...
1. cubical_quad_antenna_layout.png — Overall antenna layout
2. cubical_quad_circuit_schematic.png — Feed network and matching
3. cubical_quad_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **cubical_quad.nec** file for complete NEC2 electromagnetic model.

---

**End of cubical quad Technical Specification**
