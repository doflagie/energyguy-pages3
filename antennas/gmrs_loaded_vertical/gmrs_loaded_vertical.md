# GMRS-LOADED-VERTICAL ANTENNA
## TECHNICAL DATA SHEET

**Document Number:** TM-GMRS-LOADED-001 Rev A
**Equipment:** GMRS-LOADED-VERTICAL ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | Gmrs-loaded-vertical |
| **Design approach** | Center-loaded vertical with dual-frequency traps |
| **Frequency bands** | 462 MHz, 467 MHz |
...
**Operating Principle:**
Center-loaded vertical with dual-frequency traps

**Physical Design:**
• Compaction: 20% of full-size
• Special parameters: Trap pair 462.5/467.5 MHz, 1.5m radiator, 8 radials
...
**Model file:** gmrs_loaded_vertical.nec

**To simulate (4nec2 on Linux):**
```bash
4nec2 gmrs_loaded_vertical.nec &
```
...
1. gmrs_loaded_vertical_antenna_layout.png — Overall antenna layout
2. gmrs_loaded_vertical_circuit_schematic.png — Feed network and matching
3. gmrs_loaded_vertical_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **gmrs_loaded_vertical.nec** file for complete NEC2 electromagnetic model.

---

**End of Gmrs-loaded-vertical Technical Specification**
