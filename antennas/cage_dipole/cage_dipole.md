...
**Document Number:** TM-CAGE-DIPOLE-001 Rev A
**Equipment:** CAGE_DIPOLE ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | cage_dipole |
| **Design approach** | Wide-bandwidth dipole using cage construction |
...
**Operating Principle:**
Wide-bandwidth dipole using cage construction

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: 4–6 parallel wires per arm, 30–50cm cage dia
...
**Model file:** cage_dipole.nec

**To simulate (4nec2 on Linux):**
```bash
4nec2 cage_dipole.nec &
```
...
1. cage_dipole_antenna_layout.png — Overall antenna layout
2. cage_dipole_circuit_schematic.png — Feed network and matching
3. cage_dipole_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **cage_dipole.nec** file for complete NEC2 electromagnetic model.

---

**End of cage_dipole Technical Specification**
