...
**Document Number:** TM-CROSS-POLARI-001 Rev A
**Equipment:** CROSS-POLARIZED ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | cross-polarized |
| **Design approach** | Circular polarization array (2 dipoles 90° offset) |
...
**Operating Principle:**
Circular polarization array (2 dipoles 90° offset)

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: 90° phase shift, suitable for satellite/weak-signal
...
**Model file:** cross_polarized.nec

**To simulate (4nec2 on Linux):**
```bash
4nec2 cross_polarized.nec &
```
...
1. cross_polarized_antenna_layout.png — Overall antenna layout
2. cross_polarized_circuit_schematic.png — Feed network and matching
3. cross_polarized_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **cross_polarized.nec** file for complete NEC2 electromagnetic model.

---

**End of cross-polarized Technical Specification**
