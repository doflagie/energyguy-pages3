# FOLDED-DIPOLE-3CONDUCTOR ANTENNA
## TECHNICAL DATA SHEET

**Document Number:** TM-FOLDED-DIPOL-001 Rev A
**Equipment:** FOLDED-DIPOLE-3CONDUCTOR ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | folded-dipole-3conductor |
| **Design approach** | Three-wire folded dipole, 450Ω feedpoint |
| **Frequency bands** | 40M–10M |
| **Compaction factor** | 0% |
...
**Operating Principle:**
Three-wire folded dipole, 450Ω feedpoint

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: Triple radiator, high impedance, narrow bandwidth
...
**Model file:** folded_dipole_3conductor.nec

**To simulate (4nec2):**
```bash
4nec2 folded_dipole_3conductor.nec &
```
...
1. folded_dipole_3conductor_antenna_layout.png — Overall antenna layout
2. folded_dipole_3conductor_circuit_schematic.png — Feed network and matching
3. folded_dipole_3conductor_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **folded_dipole_3conductor.nec** file for complete NEC2 electromagnetic model.

---

**End of folded-dipole-3conductor Technical Specification**
