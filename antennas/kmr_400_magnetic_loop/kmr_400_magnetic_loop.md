# KMR-400 MAGNETIC LOOP ANTENNA
## TECHNICAL DATA SHEET

**Document Number:** TM-KMR-400-MAGN-001 Rev A
**Equipment:** KMR-400 MAGNETIC LOOP ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | KMR-400 magnetic loop |
| **Design approach** | Compact switchable magnetic loop, manually tuned |
| **Frequency bands** | 2M, 1.25M, 70cm, 33cm, 20cm |
| **Compaction factor** | 0% |
...
**Operating Principle:**
Compact switchable magnetic loop, manually tuned

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: Loop dia 25cm, tap-switched per band, high Q
...
**Model file:** kmr_400_magnetic_loop.nec

**To simulate (4nec2 on Linux):**
```bash
4nec2 kmr_400_magnetic_loop.nec &
```
...
1. kmr_400_magnetic_loop_antenna_layout.png — Overall antenna layout
2. kmr_400_magnetic_loop_circuit_schematic.png — Feed network and matching
3. kmr_400_magnetic_loop_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **kmr_400_magnetic_loop.nec** file for complete NEC2 electromagnetic model.

---

**End of KMR-400 magnetic loop Technical Specification**
