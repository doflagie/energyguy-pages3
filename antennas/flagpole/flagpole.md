...
**Document Number:** TM-FLAGPOLE-001 Rev A
**Equipment:** FLAGPOLE ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | flagpole |
| **Design approach** | End-fed whip on vertical support structure |
...
**Operating Principle:**
End-fed whip on vertical support structure

**Physical Design:**
• Compaction: 60% of full-size
• Special parameters: 5–10 ft whip, coil-loaded, base matching network
...
1. flagpole_antenna_layout.png — Overall antenna layout
2. flagpole_circuit_schematic.png — Feed network and matching
3. flagpole_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **flagpole.nec** file for complete NEC2 electromagnetic model.

---

**End of flagpole Technical Specification**
