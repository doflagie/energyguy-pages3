# EXTENDED_DOUBLE_ZEPP ANTENNA
## TECHNICAL DATA SHEET

**Document Number:** TM-EXTENDED-DOU-001 Rev A
**Equipment:** EXTENDED_DOUBLE_ZEPP ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | extended_double_zepp |
| **Design approach** | 1.25λ dipole with end-fed high-Z configuration |
| **Frequency bands** | 40M, 20M, 15M, 10M |
| **Compaction factor** | 0% |
...
**Operating Principle:**
1.25λ dipole with end-fed high-Z configuration

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: 300Ω twin-lead, 50+ ft length, pattern sharpening
...
**Model file:** extended_double_zepp.nec

**To simulate (4nec2):**
```bash
4nec2 extended_double_zepp.nec &
```
...
1. extended_double_zepp_antenna_layout.png — Overall antenna layout
2. extended_double_zepp_circuit_schematic.png — Feed network and matching
3. extended_double_zepp_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **extended_double_zepp.nec** file for complete NEC2 electromagnetic model.

---

**End of extended_double_zepp Technical Specification**
