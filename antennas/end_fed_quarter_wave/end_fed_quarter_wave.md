# END FED QUARTER WAVE ANTENNA
## TECHNICAL DATA SHEET

**Document Number:** TM-END-FED-QUAR-001 Rev A
**Equipment:** END FED QUARTER WAVE ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | end fed quarter wave |
| **Design approach** | Single-band EFQW with 9:1 balun/unun |
| **Frequency bands** | 80M, 40M, 20M |
| **Compaction factor** | 0% |
...
**Operating Principle:**
Single-band EFQW with 9:1 balun/unun

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: 66–130 ft length (band-dependent), portable
...
**Model file:** end_fed_quarter_wave.nec

**To simulate (4nec2):**
```bash
4nec2 end_fed_quarter_wave.nec &
```
...
1. end_fed_quarter_wave_antenna_layout.png — Overall antenna layout
2. end_fed_quarter_wave_circuit_schematic.png — Feed network and matching
3. end_fed_quarter_wave_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **end_fed_quarter_wave.nec** file for complete NEC2 electromagnetic model.

---

**End of end fed quarter wave Technical Specification**
