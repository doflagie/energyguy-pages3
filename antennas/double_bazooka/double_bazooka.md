# DOUBLE_BAZOOKA ANTENNA
## TECHNICAL DATA SHEET

**Document Number:** TM-DOUBLE-BAZOO-001 Rev A
**Equipment:** DOUBLE_BAZOOKA ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | double_bazooka |
| **Design approach** | Balanced parallel-wire dipole, inherent balun |
| **Frequency bands** | 40M, 20M |
| **Compaction factor** | 0% |
...
**Operating Principle:**
Balanced parallel-wire dipole, inherent balun

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: 300Ω twin-lead sections, high impedance, excellent BW
...
**Model file:** double_bazooka.nec

**To simulate (4nec2 on Linux):**
```bash
4nec2 double_bazooka.nec &
```
...
1. double_bazooka_antenna_layout.png — Overall antenna layout
2. double_bazooka_circuit_schematic.png — Feed network and matching
3. double_bazooka_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **double_bazooka.nec** file for complete NEC2 electromagnetic model.

---

**End of double_bazooka Technical Specification**
