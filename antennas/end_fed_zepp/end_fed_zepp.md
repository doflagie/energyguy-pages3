# END_FED_ZEPP ANTENNA
## TECHNICAL DATA SHEET

**Document Number:** TM-END-FED-ZEPP-001 Rev A
**Equipment:** END_FED_ZEPP ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | end_fed_zepp |
| **Design approach** | Zepp-fed end-off-center dipole (high Z feed point) |
| **Frequency bands** | 160M, 80M, 40M, 20M, 15M, 10M |
| **Compaction factor** | 0% |
...
**Operating Principle:**
Zepp-fed end-off-center dipole (high Z feed point)

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: Open-wire feeder, high impedance match, tuner required
...
**Model file:** end_fed_zepp.nec

**To simulate (4nec2):**
```bash
4nec2 end_fed_zepp.nec &
```
...
1. end_fed_zepp_antenna_layout.png — Overall antenna layout
2. end_fed_zepp_circuit_schematic.png — Feed network and matching
3. end_fed_zepp_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **end_fed_zepp.nec** file for complete NEC2 electromagnetic model.

---

**End of end_fed_zepp Technical Specification**
