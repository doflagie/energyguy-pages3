...
**Document Number:** TM-END-FED-RAND-001 Rev A
**Equipment:** END FED RANDOM WIRE ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | end fed random wire |
| **Design approach** | Broadband EFHW using random length, tuned feed |
| **Frequency bands** | 160M–6M |
| **Compaction factor** | 70% |
| **Primary application** | Amateur radio, field deployment |

### 1.2 Design Characteristics

**Operating Principle:**
Broadband EFHW using random length, tuned feed

**Physical Design:**
• Compaction: 70% of full-size
• Special parameters: 40–100 ft random wire, capacitive coupler, ATU required
...
**Model file:** end_fed_random_wire.nec

**To simulate (4nec2):**
```bash
4nec2 end_fed_random_wire.nec &
```
...
1. end_fed_random_wire_antenna_layout.png — Overall antenna layout
2. end_fed_random_wire_circuit_schematic.png — Feed network and matching
3. end_fed_random_wire_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **end_fed_random_wire.nec** file for complete NEC2 electromagnetic model.

---

**End of end fed random wire Technical Specification**
