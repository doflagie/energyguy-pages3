# DELTA LOOP 40M ANTENNA
## TECHNICAL DATA SHEET

**Document Number:** TM-DELTA-LOOP-4-001 Rev A
**Equipment:** DELTA LOOP 40M ANTENNA
...
**Approach:** Full-wavelength triangular resonant loop, broadside radiation pattern, low takeoff angle
**Compaction:** 0%
...
Full-wavelength triangular resonant loop, broadside radiation pattern, low takeoff angle

**Special parameters:** 130 ft perimeter triangle, equilateral sides ~43 ft, 50Ω feedpoint at base corner, low-angle DX pattern
...
See detailed specification in delta_loop_40m_specs.csv
...
See delta_loop_40m.nec for electromagnetic simulation
