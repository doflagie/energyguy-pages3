# FOLDED-DIPOLE-2CONDUCTOR ANTENNA
## TECHNICAL DATA SHEET

**Document Number:** TM-FOLDED-DIPOL-001 Rev A
**Equipment:** FOLDED-DIPOLE-2CONDUCTOR ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | folded-dipole-2conductor |
| **Design approach** | Two-wire folded dipole, 200Ω feedpoint |
| **Frequency bands** | 80M–10M |
| **Compaction factor** | 0% |
...
**Operating Principle:**
Two-wire folded dipole, 200Ω feedpoint

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: Twin radiator, 4:1 impedance step-up, broadband
...
**Model file:** folded_dipole_2conductor.nec

**To simulate (4nec2):**
```bash
4nec2 folded_dipole_2conductor.nec &
```
...
1. folded_dipole_2conductor_antenna_layout.png — Overall antenna layout
2. folded_dipole_2conductor_circuit_schematic.png — Feed network and matching
3. folded_dipole_2conductor_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **folded_dipole_2conductor.nec** file for complete NEC2 electromagnetic model.

---

**End of folded-dipole-2conductor Technical Specification**
