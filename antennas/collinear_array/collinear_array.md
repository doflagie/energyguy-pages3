# COLLINEAR_ARRAY ANTENNA
## TECHNICAL DATA SHEET

**Document Number:** TM-COLLINEAR-AR-001 Rev A
**Equipment:** COLLINEAR_ARRAY ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | collinear_array |
| **Design approach** | Stacked dipoles with phasing harness |
...
**Operating Principle:**
Stacked dipoles with phasing harness

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: 4-element 2M (2.0 dBi gain), 8-element 70cm (7 dBi)
...
**Model file:** collinear_array.nec

**To simulate (4nec2 on Linux):**
```bash
4nec2 collinear_array.nec &
```
...
1. collinear_array_antenna_layout.png — Overall antenna layout
2. collinear_array_circuit_schematic.png — Feed network and matching
3. collinear_array_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **collinear_array.nec** file for complete NEC2 electromagnetic model.

---

**End of collinear_array Technical Specification**
