...
**Document Number:** TM-FLOWER-POT-001 Rev A
**Equipment:** FLOWER_POT ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | flower_pot |
| **Design approach** | Omnidirectional VHF/UHF radiator (inverted cone) |
...
**Operating Principle:**
Omnidirectional VHF/UHF radiator (inverted cone)

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: No balun needed, 50Ω direct feed, ~2 dBi gain
...
**Model file:** flower_pot.nec

**To simulate (4nec2):**
```bash
4nec2 flower_pot.nec &
```
...
1. flower_pot_antenna_layout.png — Overall antenna layout
2. flower_pot_circuit_schematic.png — Feed network and matching
3. flower_pot_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **flower_pot.nec** file for complete NEC2 electromagnetic model.

---

**End of flower_pot Technical Specification**
