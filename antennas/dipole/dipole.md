...
**Document Number:** TM-DIPOLE-001 Rev A
**Equipment:** DIPOLE ANTENNA
...
|-----------|-------|
| **Antenna type** | dipole |
| **Design approach** | Half-wave dipole, center-fed, horizontal deployment |
| **Frequency bands** | 160M, 80M, 40M, 20M, 10M |
| **Compaction factor** | 0% |
...
**Operating Principle:**
Half-wave dipole, center-fed, horizontal deployment

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: Inverted vee or horizontal, 50Ω feed, 1:1 balun
...
1. dipole_antenna_layout.png — Overall antenna layout
2. dipole_circuit_schematic.png — Feed network and matching
3. dipole_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **dipole.nec** file for complete NEC2 electromagnetic model.

---

**End of dipole Technical Specification**
