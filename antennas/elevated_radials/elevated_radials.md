# ELEVATED-RADIALS ANTENNA
## TECHNICAL DATA SHEET

**Document Number:** TM-ELEVATED-RAD-001 Rev A
**Equipment:** ELEVATED-RADIALS ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | elevated-radials |
| **Design approach** | Vertical with elevated radial system (no ground needed) |
...
**Operating Principle:**
Vertical with elevated radial system (no ground needed)

**Physical Design:**
• Compaction: 30% of full-size
• Special parameters: 8–16 radials at 1.5–2m height, shortening coils
...
**Model file:** elevated_radials.nec

**To simulate (4nec2 on Linux):**
```bash
4nec2 elevated_radials.nec &
```
...
1. elevated_radials_antenna_layout.png — Overall antenna layout
2. elevated_radials_circuit_schematic.png — Feed network and matching
3. elevated_radials_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **elevated_radials.nec** file for complete NEC2 electromagnetic model.

---

**End of elevated-radials Technical Specification**
