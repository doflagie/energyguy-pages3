...
**Document Number:** TM-BEVERAGE-REC-001 Rev A
**Equipment:** BEVERAGE RECEIVING ANTENNA
...
| Parameter | Value |
|-----------|-------|
| **Antenna type** | beverage receiving |
| **Design approach** | Terminated long-wire broadside receiving array |
...
**Operating Principle:**
Terminated long-wire broadside receiving array

**Physical Design:**
• Compaction: 0% of full-size
• Special parameters: 120–240m length, 600Ω terminator, ~10 dB gain
...
**Model file:** beverage_receiving.nec

**To simulate (4nec2 on Linux):**
```bash
4nec2 beverage_receiving.nec &
```
...
1. beverage_receiving_antenna_layout.png — Overall antenna layout
2. beverage_receiving_circuit_schematic.png — Feed network and matching
3. beverage_receiving_construction_detail.png — Construction details

---

## APPENDIX C — NEC MODEL LISTING

See **beverage_receiving.nec** file for complete NEC2 electromagnetic model.

---

**End of beverage receiving Technical Specification**
