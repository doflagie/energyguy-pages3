# Final Assessment — SHUNT-FED VERTICAL ANTENNA
**[TM-ANT-056 — Open Handout](../../antennas/shunt_fed/tm.html)**
**Course:** TM-ANT-056
**Reference:** TM-ANT-056 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the SHUNT-FED VERTICAL ANTENNA?
State it in one sentence using technical terms.

**Q2.** Grounded vertical radiator (tower or monopole) fed by a shunt wire tapped at a point where impedance equals 50 ω. A vert
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the SHUNT-FED VERTICAL ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the SHUNT-FED VERTICAL ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the SHUNT-FED VERTICAL ANTENNA?
...
conclude about the SHUNT-FED VERTICAL ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-056.*
