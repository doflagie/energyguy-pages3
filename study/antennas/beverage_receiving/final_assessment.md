# Final Assessment — BEVERAGE RECEIVING ANTENNA
**[TM-ANT-010 — Open Handout](../../antennas/beverage_receiving/tm.html)**
**Course:** TM-ANT-010
**Reference:** TM-ANT-010 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the BEVERAGE RECEIVING ANTENNA?
State it in one sentence using technical terms.

**Q2.** Terminated long-wire broadside receiving array with ~600 ω resistive terminator. Receive-only antennas exploit directivi
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the BEVERAGE RECEIVING ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the BEVERAGE RECEIVING ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the BEVERAGE RECEIVING ANTENNA?
...
conclude about the BEVERAGE RECEIVING ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-010.*
