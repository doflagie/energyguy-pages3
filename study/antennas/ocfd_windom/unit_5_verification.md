...
Open TM-ANT-048. Read **Chapter 7 — Verification** completely.
...
|---|---|---|
| SWR at resonance | < 2.0:1 after ATU | ____ |
| Resonant frequency | Within ±1% of design | ____ |
| Feed impedance (R) | As designed (±15%) | ____ |
| Feed reactance (X) | <±10 Ω at resonance | ____ |
| Gain (NEC2 model) | 2–4 dBi per band | ____ |
| Efficiency | 82–94% (feeder loss minimal) | ____ |

1. Confirm SWR <2.0:1 after ATU at center frequency.
...
Criterion: **SWR <2.0:1 after ATU at center frequency**
