# Final Assessment — TURNSTILE CALIBRATION (HOMEBREW)
**[TM-ANT-008 — Open Handout](../../antennas/turnstile/tm.html)**
**Course:** TM-ANT-008
**Reference:** TM-ANT-008 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the TURNSTILE CALIBRATION (HOMEBREW)?
State it in one sentence using technical terms.

**Q2.** Calibration compares the Turnstile response to a known reference. For antennas, the reference comes from physical dimens
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the TURNSTILE CALIBRATION (HOMEBREW)?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the TURNSTILE CALIBRATION (HOMEBREW).
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the TURNSTILE CALIBRATION (HOMEBREW)?
...
conclude about the TURNSTILE CALIBRATION (HOMEBREW)? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-008.*
