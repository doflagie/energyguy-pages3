# Final Assessment — TAPE MEASURE YAGI ANTENNA
**[TM-ANT-063 — Open Handout](../../antennas/tape_measure_yagi/tm.html)**
**Course:** TM-ANT-063
**Reference:** TM-ANT-063 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the TAPE MEASURE YAGI ANTENNA?
State it in one sentence using technical terms.

**Q2.** Spring-steel measuring tape elements mounted on pvc boom; elements flex for storage and snap straight for use. Gain is a
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the TAPE MEASURE YAGI ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the TAPE MEASURE YAGI ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the TAPE MEASURE YAGI ANTENNA?
...
conclude about the TAPE MEASURE YAGI ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-063.*
