# Final Assessment — END-FED QUARTER-WAVE (EFQW) ANTENNA
**[TM-ANT-020 — Open Handout](../../antennas/end_fed_quarter_wave/tm.html)**
**Course:** TM-ANT-020
**Reference:** TM-ANT-020 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the END-FED QUARTER-WAVE (EFQW) ANTENNA?
State it in one sentence using technical terms.

**Q2.** Quarter-wave wire element fed at high-impedance end via 9:1 unun with short counterpoise. An end-fed wire presents a hig
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the END-FED QUARTER-WAVE (EFQW) ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the END-FED QUARTER-WAVE (EFQW) ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the END-FED QUARTER-WAVE (EFQW) ANTENNA?
...
conclude about the END-FED QUARTER-WAVE (EFQW) ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-020.*
