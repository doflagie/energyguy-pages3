# Final Assessment — END-FED HALF-WAVE (EFHW) ANTENNA
**[TM-ANT-019 — Open Handout](../../antennas/end_fed_half_wave/tm.html)**
**Course:** TM-ANT-019
**Reference:** TM-ANT-019 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the END-FED HALF-WAVE (EFHW) ANTENNA?
State it in one sentence using technical terms.

**Q2.** 86-ft wire resonant at 3.5 mhz; fed at high-impedance end via 49:1 unun transformer. An end-fed wire presents a high imp
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the END-FED HALF-WAVE (EFHW) ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the END-FED HALF-WAVE (EFHW) ANTENNA.
...
**Q6.** [Calculation] Using the formula from Appendix A (`L = 468 / fMHz`):
...
**Q7.** [Calculation] Using the formula: `Zwire = 49 × Zcoax = 49 × 50 = 2450 Ω`
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the END-FED HALF-WAVE (EFHW) ANTENNA?
...
conclude about the END-FED HALF-WAVE (EFHW) ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-019.*
...
**A6.** Formula: `L = 468 / fMHz`. Frequency 10% higher = element 10% shorter. Confirm your result is physically plausible (shorter wire = higher frequency).
*TM ref: App. A*

**A7.** Formula: `Zwire = 49 × Zcoax = 49 × 50 = 2450 Ω`. Show substitution, arithmetic, result with units.
*TM ref: App. A*
...
**A11.** Criterion: 2.0:1 on harmonics | ____ |. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
