...
**Q1.** What is the operating principle of the LOG PERIODIC DIPOLE ARRAY (LPDA) — WIDEBAND?
State it in one sentence using technical terms.

**Q2.** Multi-element lpda designed with log-periodic taper ratio τ ≈ 0.9 and spacing factor σ ≈ 0.05 for maximum gain/bandwidth
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the LOG PERIODIC DIPOLE ARRAY (LPDA) — WIDEBAND?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the LOG PERIODIC DIPOLE ARRAY (LPDA) — WIDEBAND.
...
**Q6.** [Calculation] Using the formula from Appendix A (`λ = 300 / fMHz`):
...
**Q7.** [Calculation] Using the formula: `ΔL = &minus;0.0085 × dboom × delem / λ² (approximate)`
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the LOG PERIODIC DIPOLE ARRAY (LPDA) — WIDEBAND?
...
conclude about the LOG PERIODIC DIPOLE ARRAY (LPDA) — WIDEBAND? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-044.*
...
**A6.** Formula: `λ = 300 / fMHz`. Frequency 10% higher = element 10% shorter. Confirm your result is physically plausible (shorter wire = higher frequency).
*TM ref: App. A*

**A7.** Formula: `ΔL = &minus;0.0085 × dboom × delem / λ² (approximate)`. Show substitution, arithmetic, result with units.
*TM ref: App. A*
...
**A11.** Criterion: 2.0:1 across band | ____ |. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
