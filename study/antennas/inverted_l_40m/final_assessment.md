# Final Assessment — INVERTED-L ANTENNA — 40M
**[TM-ANT-037 — Open Handout](../../antennas/inverted_l_40m/tm.html)**
**Course:** TM-ANT-037
**Reference:** TM-ANT-037 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the INVERTED-L ANTENNA — 40M?
State it in one sentence using technical terms.

**Q2.** L-shaped wire with vertical section for radiation and horizontal section providing capacitive top-loading. A vertical ra
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the INVERTED-L ANTENNA — 40M?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the INVERTED-L ANTENNA — 40M.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the INVERTED-L ANTENNA — 40M?
...
conclude about the INVERTED-L ANTENNA — 40M? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-037.*
