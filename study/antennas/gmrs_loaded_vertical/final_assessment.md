# Final Assessment — GMRS LOADED VERTICAL ANTENNA
**[TM-ANT-033 — Open Handout](../../antennas/gmrs_loaded_vertical/tm.html)**
**Course:** TM-ANT-033
**Reference:** TM-ANT-033 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the GMRS LOADED VERTICAL ANTENNA?
State it in one sentence using technical terms.

**Q2.** Center-loaded vertical with dual-frequency lc traps for simultaneous gmrs main/sub-band coverage. A vertical radiator ca
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the GMRS LOADED VERTICAL ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the GMRS LOADED VERTICAL ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the GMRS LOADED VERTICAL ANTENNA?
...
conclude about the GMRS LOADED VERTICAL ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-033.*
