# Final Assessment — END-FED ZEPP ANTENNA
**[TM-ANT-022 — Open Handout](../../antennas/end_fed_zepp/tm.html)**
**Course:** TM-ANT-022
**Reference:** TM-ANT-022 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the END-FED ZEPP ANTENNA?
State it in one sentence using technical terms.

**Q2.** Half-wave wire radiator fed at voltage-maximum (current-minimum) end via parallel open-wire feeder into balanced atu. An
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the END-FED ZEPP ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the END-FED ZEPP ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the END-FED ZEPP ANTENNA?
...
conclude about the END-FED ZEPP ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-022.*
