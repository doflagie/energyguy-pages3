# Final Assessment — TELESCOPIC WHIP ANTENNA
**[TM-ANT-064 — Open Handout](../../antennas/telescopic/tm.html)**
**Course:** TM-ANT-064
**Reference:** TM-ANT-064 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the TELESCOPIC WHIP ANTENNA?
State it in one sentence using technical terms.

**Q2.** Multi-segment collapsing whip antenna with base coil and tuning coil for band change; portable and field-deployable. A v
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the TELESCOPIC WHIP ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the TELESCOPIC WHIP ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the TELESCOPIC WHIP ANTENNA?
...
conclude about the TELESCOPIC WHIP ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-064.*
