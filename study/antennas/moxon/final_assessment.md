# Final Assessment — MOXON RECTANGLE ANTENNA
**[TM-ANT-046 — Open Handout](../../antennas/moxon/tm.html)**
**Course:** TM-ANT-046
**Reference:** TM-ANT-046 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the MOXON RECTANGLE ANTENNA?
State it in one sentence using technical terms.

**Q2.** Modified cubical quad with folded tips to form a compact rectangular two-element beam; one driven, one reflector. Gain i
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the MOXON RECTANGLE ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the MOXON RECTANGLE ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the MOXON RECTANGLE ANTENNA?
...
conclude about the MOXON RECTANGLE ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-046.*
...
**A11.** Criterion: 97% | ____ |. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
