# Final Assessment — COMPACT TRAP DIPOLE
**[TM-ANT-013 — Open Handout](../../antennas/compact-dipole/tm.html)**
**Course:** TM-ANT-013
**Reference:** TM-ANT-013 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the COMPACT TRAP DIPOLE?
State it in one sentence using technical terms.

**Q2.** Center-fed dipole with lc trap pairs at element junctions to achieve multiband resonance at reduced physical length. A d
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the COMPACT TRAP DIPOLE?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the COMPACT TRAP DIPOLE.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the COMPACT TRAP DIPOLE?
...
conclude about the COMPACT TRAP DIPOLE? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-013.*
