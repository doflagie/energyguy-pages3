# Final Assessment — FAN DIPOLE ANTENNA
**[TM-ANT-024 — Open Handout](../../antennas/fan_dipole/tm.html)**
**Course:** TM-ANT-024
**Reference:** TM-ANT-024 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the FAN DIPOLE ANTENNA?
State it in one sentence using technical terms.

**Q2.** Multiple dipole pairs cut to separate bands, all connected at a common center feedpoint and flared outward. A dipole rad
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the FAN DIPOLE ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the FAN DIPOLE ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the FAN DIPOLE ANTENNA?
...
conclude about the FAN DIPOLE ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-024.*
...
**A11.** Criterion: SWR <1.5:1 per band at center frequency. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
