...
Open TM-ANT-024. Read **Chapter 7 — Verification** completely.
...
|---|---|---|
| SWR at resonance | < 1.5:1 per band | ____ |
...
| Efficiency | 88–95% per band | ____ |

1. Confirm SWR <1.5:1 per band at center frequency.
...
Criterion: **SWR <1.5:1 per band at center frequency**
