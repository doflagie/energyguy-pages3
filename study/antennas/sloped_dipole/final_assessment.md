# Final Assessment — SLOPED DIPOLE ANTENNA
**[TM-ANT-059 — Open Handout](../../antennas/sloped_dipole/tm.html)**
**Course:** TM-ANT-059
**Reference:** TM-ANT-059 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the SLOPED DIPOLE ANTENNA?
State it in one sentence using technical terms.

**Q2.** Standard center-fed dipole tilted at 30–45° from horizontal, producing asymmetric directional pattern with low-angle com
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the SLOPED DIPOLE ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the SLOPED DIPOLE ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the SLOPED DIPOLE ANTENNA?
...
conclude about the SLOPED DIPOLE ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-059.*
