# Final Assessment — HEX LOOP ANTENNA
**[TM-ANT-036 — Open Handout](../../antennas/hex_loop/tm.html)**
**Course:** TM-ANT-036
**Reference:** TM-ANT-036 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the HEX LOOP ANTENNA?
State it in one sentence using technical terms.

**Q2.** Six-sided (hexagonal) full-wave loop fed at one side corner; horizontal polarization in broadside direction. A full-wave
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the HEX LOOP ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the HEX LOOP ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the HEX LOOP ANTENNA?
...
conclude about the HEX LOOP ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-036.*
