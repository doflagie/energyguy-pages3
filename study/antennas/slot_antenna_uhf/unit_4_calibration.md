...
**ELOs:** Calibrate the SLOT ANTENNA — UHF 70cm to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-060. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
```
Special parameters
36 mm slot on PCB ground plane; 50 Ω microstrip feed at slot center; wideband for full 70cm band coverage
```
...
**P4-1.** The design frequency of the SLOT ANTENNA — UHF 70cm is stated in Chapter 1. Using the formula from Appendix A,
