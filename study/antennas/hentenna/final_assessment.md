# Final Assessment — HENTENNA CALIBRATION (HOMEBREW)
**[TM-ANT-004 — Open Handout](../../antennas/hentenna/tm.html)**
**Course:** TM-ANT-004
**Reference:** TM-ANT-004 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the HENTENNA CALIBRATION (HOMEBREW)?
State it in one sentence using technical terms.

**Q2.** Calibration compares the Hentenna response to a known reference. For antennas, the reference comes from physical dimensi
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the HENTENNA CALIBRATION (HOMEBREW)?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the HENTENNA CALIBRATION (HOMEBREW).
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the HENTENNA CALIBRATION (HOMEBREW)?
...
conclude about the HENTENNA CALIBRATION (HOMEBREW)? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-004.*
