# Final Assessment — DELTA LOOP ANTENNA — 40M
**[TM-ANT-016 — Open Handout](../../antennas/delta_loop_40m/tm.html)**
**Course:** TM-ANT-016
**Reference:** TM-ANT-016 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the DELTA LOOP ANTENNA — 40M?
State it in one sentence using technical terms.

**Q2.** Full-wavelength triangular loop with low radiation angle for dx propagation. A full-wave loop fed at any point resonates
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the DELTA LOOP ANTENNA — 40M?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the DELTA LOOP ANTENNA — 40M.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the DELTA LOOP ANTENNA — 40M?
...
conclude about the DELTA LOOP ANTENNA — 40M? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-016.*
