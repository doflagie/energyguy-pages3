...
**ELOs:** Calibrate the DELTA LOOP ANTENNA — 40M to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-016. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
**P4-1.** The design frequency of the DELTA LOOP ANTENNA — 40M is stated in Chapter 1. Using the formula from Appendix A,
