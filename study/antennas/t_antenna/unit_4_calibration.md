...
**ELOs:** Calibrate the T-ANTENNA (INVERTED-T) to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-061. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
**P4-1.** The design frequency of the T-ANTENNA (INVERTED-T) is stated in Chapter 1. Using the formula from Appendix A,
