# Final Assessment — DOUBLE BAZOOKA DIPOLE
**[TM-ANT-017 — Open Handout](../../antennas/double_bazooka/tm.html)**
**Course:** TM-ANT-017
**Reference:** TM-ANT-017 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the DOUBLE BAZOOKA DIPOLE?
State it in one sentence using technical terms.

**Q2.** Center-fed dipole with coaxial stub sections forming a sleeve balun and bandwidth-broadening structure. A dipole radiate
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the DOUBLE BAZOOKA DIPOLE?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the DOUBLE BAZOOKA DIPOLE.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the DOUBLE BAZOOKA DIPOLE?
...
conclude about the DOUBLE BAZOOKA DIPOLE? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-017.*
...
**A11.** Criterion: SWR <1.5:1 across full band at center frequency. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
