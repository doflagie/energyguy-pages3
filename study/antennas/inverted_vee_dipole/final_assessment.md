# Final Assessment — INVERTED-VEE DIPOLE ANTENNA
**[TM-ANT-038 — Open Handout](../../antennas/inverted_vee_dipole/tm.html)**
**Course:** TM-ANT-038
**Reference:** TM-ANT-038 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the INVERTED-VEE DIPOLE ANTENNA?
State it in one sentence using technical terms.

**Q2.** Standard half-wave dipole with arms sloped downward from center apex at 45–60° included angle, reducing height requireme
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the INVERTED-VEE DIPOLE ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the INVERTED-VEE DIPOLE ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the INVERTED-VEE DIPOLE ANTENNA?
...
conclude about the INVERTED-VEE DIPOLE ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-038.*
