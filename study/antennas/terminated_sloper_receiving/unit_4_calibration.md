...
**ELOs:** Calibrate the TERMINATED SLOPER RECEIVING ANTENNA to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-067. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
**P4-1.** The design frequency of the TERMINATED SLOPER RECEIVING ANTENNA is stated in Chapter 1. Using the formula from Appendix A,
