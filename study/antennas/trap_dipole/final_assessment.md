# Final Assessment — TRAP DIPOLE ANTENNA
**[TM-ANT-069 — Open Handout](../../antennas/trap_dipole/tm.html)**
**Course:** TM-ANT-069
**Reference:** TM-ANT-069 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the TRAP DIPOLE ANTENNA?
State it in one sentence using technical terms.

**Q2.** Standard half-wave dipole extended with lc trap pairs resonant at band edges; each trap isolates the inner element for i
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the TRAP DIPOLE ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the TRAP DIPOLE ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the TRAP DIPOLE ANTENNA?
...
conclude about the TRAP DIPOLE ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-069.*
...
**A11.** Criterion: SWR <2.0:1 per band at center frequency. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
