...
**ELOs:** Calibrate the END-FED RANDOM WIRE (EFRW) ANTENNA to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
**P4-1.** The design frequency of the END-FED RANDOM WIRE (EFRW) ANTENNA is stated in Chapter 1. Using the formula from Appendix A,
