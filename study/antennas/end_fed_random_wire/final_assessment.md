# Final Assessment — END-FED RANDOM WIRE (EFRW) ANTENNA
**[TM-ANT-021 — Open Handout](../../antennas/end_fed_random_wire/tm.html)**
**Course:** TM-ANT-021
**Reference:** TM-ANT-021 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the END-FED RANDOM WIRE (EFRW) ANTENNA?
State it in one sentence using technical terms.

**Q2.** Random-length wire (avoid multiples of λ/2 per band) fed via 9:1 or capacitive coupler into atu. An end-fed wire present
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the END-FED RANDOM WIRE (EFRW) ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the END-FED RANDOM WIRE (EFRW) ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the END-FED RANDOM WIRE (EFRW) ANTENNA?
...
conclude about the END-FED RANDOM WIRE (EFRW) ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-021.*
...
**A11.** Criterion: 2.0:1 after ATU | ____ |. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
