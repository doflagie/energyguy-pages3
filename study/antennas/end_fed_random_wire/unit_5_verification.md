...
Open TM-ANT-021. Read **Chapter 7 — Verification** completely.
...
|---|---|---|
| SWR at design frequency | < 2.0:1 after ATU | ____ |
| Common-mode current on coax | Not perceptible at feed end | ____ |
| Gain (NEC2) | 2–4 dBi (length and frequency dependent) | ____ |
| Efficiency | 75–90% (ATU loss + wire resistance) | ____ |
...
Criterion: **2.0:1 after ATU | ____ |**
