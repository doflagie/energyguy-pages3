# Final Assessment — VERTICAL DIPOLE ANTENNA
**[TM-ANT-072 — Open Handout](../../antennas/vertical_dipole/tm.html)**
**Course:** TM-ANT-072
**Reference:** TM-ANT-072 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the VERTICAL DIPOLE ANTENNA?
State it in one sentence using technical terms.

**Q2.** Standard half-wave dipole oriented vertically; requires balun to prevent feed line radiation. A vertical radiator carrie
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the VERTICAL DIPOLE ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the VERTICAL DIPOLE ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the VERTICAL DIPOLE ANTENNA?
...
conclude about the VERTICAL DIPOLE ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-072.*
