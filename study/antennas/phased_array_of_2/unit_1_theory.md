...
**ELOs:** Understand the operating principle of the PHASED ARRAY — 2-ELEMENT; identify key electrical characteristics
...
Open TM-ANT-052. Read **Chapter 2 — Theory of Operation** completely.
...
Two co-planar dipoles spaced 0.5λ apart with phasing harness providing 90° current phase shift between elements. Key parameters: 0.5λ spacing between elements; phasing harness from matched coax lengths; ~3–4 dBi gain, cardioid pattern.

### 2-2. RADIATION CHARACTERISTICS

Gain: 3–4 dBi. Efficiency: 85–95%. Feed impedance: 50 Ω (phasing harness output). The pattern and polarization depend on the specific antenna geometry; consult the NEC2 model for accurate polar plots and gain/elevation data.
...
**SC1-1.** In one sentence, state the operating principle of the PHASED ARRAY — 2-ELEMENT as described in Chapter 2.

**SC1-2.** What determines the resonant frequency of the PHASED ARRAY — 2-ELEMENT? Name the primary physical parameter(s).

**SC1-3.** What feedpoint impedance does Chapter 2 predict for the PHASED ARRAY — 2-ELEMENT in free space? How does that change over real ground?

**SC1-4.** What radiation pattern does the PHASED ARRAY — 2-ELEMENT produce? What are the nulls and maxima directions?
...
- The operating principle of the PHASED ARRAY — 2-ELEMENT
