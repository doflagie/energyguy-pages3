# Final Assessment — PHASED ARRAY — 2-ELEMENT
**[TM-ANT-052 — Open Handout](../../antennas/phased_array_of_2/tm.html)**
**Course:** TM-ANT-052
**Reference:** TM-ANT-052 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the PHASED ARRAY — 2-ELEMENT?
State it in one sentence using technical terms.

**Q2.** Two co-planar dipoles spaced 0.5λ apart with phasing harness providing 90° current phase shift between elements. Key par
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the PHASED ARRAY — 2-ELEMENT?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the PHASED ARRAY — 2-ELEMENT.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the PHASED ARRAY — 2-ELEMENT?
...
conclude about the PHASED ARRAY — 2-ELEMENT? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-052.*
