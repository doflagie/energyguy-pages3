# Final Assessment — FRAME LOOP RECEIVING/TRANSMITTING ANTENNA
**[TM-ANT-030 — Open Handout](../../antennas/frame_loop/tm.html)**
**Course:** TM-ANT-030
**Reference:** TM-ANT-030 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the FRAME LOOP RECEIVING/TRANSMITTING ANTENNA?
State it in one sentence using technical terms.

**Q2.** Large square loop (perimeter > λ) tuned with series or parallel capacitor; high radiation resistance, low loss. Receive-
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the FRAME LOOP RECEIVING/TRANSMITTING ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the FRAME LOOP RECEIVING/TRANSMITTING ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the FRAME LOOP RECEIVING/TRANSMITTING ANTENNA?
...
conclude about the FRAME LOOP RECEIVING/TRANSMITTING ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-030.*
...
**A11.** Criterion: 2.0:1 | ____ |. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
