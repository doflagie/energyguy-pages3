...
**ELOs:** Calibrate the CUBICAL QUAD ANTENNA to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-015. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
**P4-1.** The design frequency of the CUBICAL QUAD ANTENNA is stated in Chapter 1. Using the formula from Appendix A,
