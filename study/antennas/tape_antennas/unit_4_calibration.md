...
**ELOs:** Calibrate the TAPE ANTENNAS to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-062. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
```
Special parameters
Flexible copper tape, 85% compact vs. rigid equivalent; vacuum-formed array possible; deployed with spreaders
```
...
**P4-1.** The design frequency of the TAPE ANTENNAS is stated in Chapter 1. Using the formula from Appendix A,
