# Final Assessment — DIPOLE CALIBRATION (HOMEBREW)
**[TM-ANT-001 — Open Handout](../../antennas/dipole/tm.html)**
**Course:** TM-ANT-001
**Reference:** TM-ANT-001 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the DIPOLE CALIBRATION (HOMEBREW)?
State it in one sentence using technical terms.

**Q2.** Calibration compares the Dipole response to a known reference. For antennas, the reference comes from physical dimension
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the DIPOLE CALIBRATION (HOMEBREW)?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the DIPOLE CALIBRATION (HOMEBREW).
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the DIPOLE CALIBRATION (HOMEBREW)?
...
conclude about the DIPOLE CALIBRATION (HOMEBREW)? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-001.*
