...
**ELOs:** Calibrate the HELICAL ANTENNA — 2M SATELLITE to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-035. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
```
Special parameters
3-turn helix, 4.5 in diameter, 4.5 in pitch, ~8 dBic gain, RHCP, 50 Ω direct feed via microstrip transformer
```
...
**P4-1.** The design frequency of the HELICAL ANTENNA — 2M SATELLITE is stated in Chapter 1. Using the formula from Appendix A,
