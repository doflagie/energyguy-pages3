...
Open TM-ANT-035. Read **Chapter 4 — Assembly Procedures** completely.
...
1. Extract all element lengths and spacings from NEC2 model file helical_antenna_2m_satellite.nec (GW card dimensions). Convert from meters to inches or feet for construction.
