...
Open TM-ANT-051. Read **Chapter 4 — Assembly Procedures** completely.
...
1. Extract all element lengths and spacings from NEC2 model file patch_antenna_2.4_ghz.nec (GW card dimensions). Convert from meters to inches or feet for construction.
