...
**ELOs:** Calibrate the PATCH ANTENNA — 2.4 GHz to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-051. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
```
Special parameters
~50 mm × 65 mm patch on FR4 (εr = 4.4) h = 1.6 mm; 50 Ω coaxial probe or edge feed; linear polarization
```
...
**P4-1.** The design frequency of the PATCH ANTENNA — 2.4 GHz is stated in Chapter 1. Using the formula from Appendix A,
