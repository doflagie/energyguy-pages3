# Final Assessment — TELESCOPIC VERTICAL ANTENNA
**[TM-ANT-065 — Open Handout](../../antennas/telescopic_vertical/tm.html)**
**Course:** TM-ANT-065
**Reference:** TM-ANT-065 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the TELESCOPIC VERTICAL ANTENNA?
State it in one sentence using technical terms.

**Q2.** Telescoping multi-section vertical antenna adjusted to quarter-wave at target frequency; tapped loading coil for lower b
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the TELESCOPIC VERTICAL ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the TELESCOPIC VERTICAL ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the TELESCOPIC VERTICAL ANTENNA?
...
conclude about the TELESCOPIC VERTICAL ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-065.*
