# Final Assessment — SLIM JIM ANTENNA
**[TM-ANT-057 — Open Handout](../../antennas/slim_jim/tm.html)**
**Course:** TM-ANT-057
**Reference:** TM-ANT-057 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the SLIM JIM ANTENNA?
State it in one sentence using technical terms.

**Q2.** End-fed folded dipole (j-pole variant) using flat ribbon cable; j-match provides 50 ω at feed tap. A vertical radiator c
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the SLIM JIM ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the SLIM JIM ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the SLIM JIM ANTENNA?
...
conclude about the SLIM JIM ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-057.*
