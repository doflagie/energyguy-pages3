...
Open TM-ANT-014. Read **Chapter 4 — Assembly Procedures** completely.
...
1. Extract all element lengths and spacings from NEC2 model file cross_polarized.nec (GW card dimensions). Convert from meters to inches or feet for construction.
