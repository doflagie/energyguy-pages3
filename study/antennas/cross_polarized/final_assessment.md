# Final Assessment — CROSS-POLARIZED ANTENNA
**[TM-ANT-014 — Open Handout](../../antennas/cross_polarized/tm.html)**
**Course:** TM-ANT-014
**Reference:** TM-ANT-014 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the CROSS-POLARIZED ANTENNA?
State it in one sentence using technical terms.

**Q2.** Two crossed dipoles with 90° hybrid phasing network to produce circular polarization. Key parameters: 90° phase shift vi
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the CROSS-POLARIZED ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the CROSS-POLARIZED ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the CROSS-POLARIZED ANTENNA?
...
conclude about the CROSS-POLARIZED ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-014.*
