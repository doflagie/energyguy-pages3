...
**ELOs:** Calibrate the CROSS-POLARIZED ANTENNA to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-014. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
```
Special parameters
90° phase shift via coaxial phasing harness, suitable for LEO satellite and meteor scatter work
```
...
**P4-1.** The design frequency of the CROSS-POLARIZED ANTENNA is stated in Chapter 1. Using the formula from Appendix A,
