# Final Assessment — FLAGPOLE ANTENNA
**[TM-ANT-025 — Open Handout](../../antennas/flagpole/tm.html)**
**Course:** TM-ANT-025
**Reference:** TM-ANT-025 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the FLAGPOLE ANTENNA?
State it in one sentence using technical terms.

**Q2.** End-fed vertical whip concealed within or as a flagpole structure; coil-loaded base matching network. A vertical radiato
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the FLAGPOLE ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the FLAGPOLE ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the FLAGPOLE ANTENNA?
...
conclude about the FLAGPOLE ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-025.*
