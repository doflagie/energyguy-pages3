...
**ELOs:** Calibrate the V-BEAM ANTENNA to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-071. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
5. Verify SWR ≤2.0:1 after matching at operating frequency. If not, adjust matching per Chapter 6.
...
```
Special parameters
60–120 ft legs; 120–180° apex angle; terminated or non-terminated variants; directional gain 4–8 dBi on bisector
```
...
Chapter 5 specifies a criterion: **SWR ≤2.0:1**. Confirm the exact value in the TM.
...
**P4-1.** The design frequency of the V-BEAM ANTENNA is stated in Chapter 1. Using the formula from Appendix A,
