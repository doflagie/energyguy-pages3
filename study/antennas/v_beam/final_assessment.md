# Final Assessment — V-BEAM ANTENNA
**[TM-ANT-071 — Open Handout](../../antennas/v_beam/tm.html)**
**Course:** TM-ANT-071
**Reference:** TM-ANT-071 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the V-BEAM ANTENNA?
State it in one sentence using technical terms.

**Q2.** Two long wire elements arranged in a v-shape from a common feedpoint; bidirectional pattern along the v bisector. Key pa
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the V-BEAM ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the V-BEAM ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the V-BEAM ANTENNA?
...
conclude about the V-BEAM ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-071.*
