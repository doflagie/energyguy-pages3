# Final Assessment — NEAR VERTICAL INCIDENCE SKYWAVE (NVIS) ANTENNA
**[TM-ANT-047 — Open Handout](../../antennas/near_vertical_incidence_skywave/tm.html)**
**Course:** TM-ANT-047
**Reference:** TM-ANT-047 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the NEAR VERTICAL INCIDENCE SKYWAVE (NVIS) ANTENNA?
State it in one sentence using technical terms.

**Q2.** Horizontally polarized dipole or inverted-v at low height (0.05–0.15λ above ground) producing near-vertical radiation an
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the NEAR VERTICAL INCIDENCE SKYWAVE (NVIS) ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the NEAR VERTICAL INCIDENCE SKYWAVE (NVIS) ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the NEAR VERTICAL INCIDENCE SKYWAVE (NVIS) ANTENNA?
...
conclude about the NEAR VERTICAL INCIDENCE SKYWAVE (NVIS) ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-047.*
...
**A11.** Criterion: SWR <2.0:1 at center frequency. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
