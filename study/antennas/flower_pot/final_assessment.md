# Final Assessment — FLOWER POT ANTENNA
**[TM-ANT-026 — Open Handout](../../antennas/flower_pot/tm.html)**
**Course:** TM-ANT-026
**Reference:** TM-ANT-026 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the FLOWER POT ANTENNA?
State it in one sentence using technical terms.

**Q2.** Coaxial dipole using the coax braid as the lower element and the center conductor (extended) as the upper element, using
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the FLOWER POT ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the FLOWER POT ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the FLOWER POT ANTENNA?
...
conclude about the FLOWER POT ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-026.*
