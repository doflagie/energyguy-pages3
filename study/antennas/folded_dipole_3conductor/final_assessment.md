# Final Assessment — FOLDED DIPOLE — 3-CONDUCTOR
**[TM-ANT-029 — Open Handout](../../antennas/folded_dipole_3conductor/tm.html)**
**Course:** TM-ANT-029
**Reference:** TM-ANT-029 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the FOLDED DIPOLE — 3-CONDUCTOR?
State it in one sentence using technical terms.

**Q2.** Three parallel conductors forming a triple folded dipole structure; feedpoint impedance = 9× standard dipole. A dipole r
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the FOLDED DIPOLE — 3-CONDUCTOR?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the FOLDED DIPOLE — 3-CONDUCTOR.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the FOLDED DIPOLE — 3-CONDUCTOR?
...
conclude about the FOLDED DIPOLE — 3-CONDUCTOR? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-029.*
