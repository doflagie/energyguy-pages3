# Final Assessment — OFF-CENTER FED DIPOLE (OCFD)
**[TM-ANT-050 — Open Handout](../../antennas/off_center_fed_dipole/tm.html)**
**Course:** TM-ANT-050
**Reference:** TM-ANT-050 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the OFF-CENTER FED DIPOLE (OCFD)?
State it in one sentence using technical terms.

**Q2.** Dipole fed off-center to present a workable impedance to a 4:1 balun plus 50 ω coax; multiband without tuner. A dipole r
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the OFF-CENTER FED DIPOLE (OCFD)?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the OFF-CENTER FED DIPOLE (OCFD).
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the OFF-CENTER FED DIPOLE (OCFD)?
...
conclude about the OFF-CENTER FED DIPOLE (OCFD)? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-050.*
...
**A11.** Criterion: SWR <2.0:1 on design bands at center frequency. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
