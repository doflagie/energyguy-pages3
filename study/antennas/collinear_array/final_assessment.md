# Final Assessment — COLLINEAR ARRAY ANTENNA
**[TM-ANT-012 — Open Handout](../../antennas/collinear_array/tm.html)**
**Course:** TM-ANT-012
**Reference:** TM-ANT-012 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the COLLINEAR ARRAY ANTENNA?
State it in one sentence using technical terms.

**Q2.** Stacked co-axial half-wave dipoles fed with in-phase phasing harness (coaxial stubs or phasing lines). A vertical radiat
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the COLLINEAR ARRAY ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the COLLINEAR ARRAY ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the COLLINEAR ARRAY ANTENNA?
...
conclude about the COLLINEAR ARRAY ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-012.*
