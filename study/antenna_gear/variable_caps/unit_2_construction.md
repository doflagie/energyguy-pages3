...
Open TM-GEAR-019. Read **Chapter 3 — Equipment and Materials** completely.
...
| Component | Air-variable (motorized) | Stack-on flat-plate |
|---|---|---|
| Capacitor body | Commercial air variable (365 pF, 500V) | 50×75 mm copper foil sheets |
| Dielectric | Air (3mm gap) | 0.05 mm polyimide (Kapton) or LDPE |
| Drive motor | 12V DC gear motor, 6 RPM | — |
| Drive coupling | Flexible shaft coupler, 6mm-to-6mm | — |
| Position sensor | 10-turn pot 10kΩ | — |
| Controller | ESP32 WROOM-32 | — |
| Limit switches | 2× microswitches (min and max) | — |
| OLED display | SSD1306 0.96&rdquo; | — |
| Backing | — | PVC strip, self-adhesive velcro |
