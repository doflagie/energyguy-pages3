...
Open TM-TOOL-007. Read **Chapter 3 — Equipment and Materials** completely.
...
|---|---|---|
| HF coupler core | FT-114-43 or BN-43-202 | 1.8–30 MHz coupling |
| VHF/UHF coupler | PCB microstrip, FR4 | 50–1300 MHz coupling |
| Detector diodes | 1N5711 Schottky (4×) | RF to DC conversion |
| ADC | ADS1115 16-bit I2C | DC voltage measurement |
| Controller | ESP32 WROOM-32 | ADC readout, display driver |
| Display | CYD 2.8&rdquo; ILI9341 | Power, SWR, band display |
| RF connectors | N-type female (×2) | Input/output (IN, OUT) |
| Band switch | Front-panel toggle | HF / VHF-UHF section select |
| Range switch | 4-position rotary | 1W / 10W / 100W / 1000W |
| Power | 9V battery or USB-C | ESP32, ADC, display |
