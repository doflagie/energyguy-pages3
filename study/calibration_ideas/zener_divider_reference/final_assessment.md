# Final Assessment — ZENER + DIVIDER MULTI-VOLTAGE REFERENCE
...
**1.** State the scope of TM-CAL-007: what does it cover and for what application?
...
**3.** In one sentence, state the operating principle of the ZENER + DIVIDER MULTI-VOLTAGE REFERENCE as described in Chapter 2.
...
**12.** Your measurement gives an error of 0.2%. Determine pass or fail. Show your reasoning.
