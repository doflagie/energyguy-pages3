...
Open TM-CAL-011. Read **Chapter 6** and **Chapter 7** completely.
...
> **NOTE:** The RC standard is not adjustable post-construction. Select R and C with measured values. Calculate &tau;true = Rmeas × Cmeas using measured component values as the reference, not nominal values.

---

## Chapter 7 — Verification

1. Verify calculated &tau; by oscilloscope cursors at two time-constant multiples: at 2&tau;, V = 86.5% of supply. Both measurements should be consistent.
2. Cross-check: apply 1 kHz square wave to RC input. Measure &minus;3 dB frequency with NanoVNA. f&minus;3dB = 1/(2π&tau;) = 1/(2π×100μs) = 1592 Hz.
3. Log: R measured, C measured, &tau; calculated, &tau; measured, scope timebase error %.
...
The TM states a verification criterion of: **86.5% of supply**. Confirm the exact wording in Chapter 7.
