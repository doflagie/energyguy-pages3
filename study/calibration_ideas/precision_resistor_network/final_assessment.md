# Final Assessment — PRECISION RESISTOR NETWORK (DECADE BOX)
...
**1.** State the scope of TM-CAL-008: what does it cover and for what application?
...
**3.** In one sentence, state the operating principle of the PRECISION RESISTOR NETWORK (DECADE BOX) as described in Chapter 2.
...
**12.** Your measurement gives an error of 10 Ω. Determine pass or fail. Show your reasoning.
