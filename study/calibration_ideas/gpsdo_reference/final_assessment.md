# Final Assessment — GPS-DISCIPLINED OSCILLATOR (GPSDO)
...
**1.** State the scope of TM-CAL-003: what does it cover and for what application?
...
**3.** In one sentence, state the operating principle of the GPS-DISCIPLINED OSCILLATOR (GPSDO) as described in Chapter 2.
...
**12.** Your measurement gives an error of 50 Ω. Determine pass or fail. Show your reasoning.
