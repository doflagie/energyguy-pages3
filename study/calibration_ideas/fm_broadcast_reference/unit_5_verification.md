...
Open TM-CAL-004. Read **Chapter 6** and **Chapter 7** completely.
...
3. Residual errors 3 kHz, verify that station assignment in FCC database is current (stations occasionally shift channels).
...
The TM states a verification criterion of: **3 kHz, verify that station assignment in FCC database is current (stations occasionally shift channels)**. Confirm the exact wording in Chapter 7.
