# Final Assessment — FIELD STRENGTH REFERENCE
...
**1.** State the scope of TM-CAL-017: what does it cover and for what application?
...
**3.** In one sentence, state the operating principle of the FIELD STRENGTH REFERENCE as described in Chapter 2.
