...
Open TM-CAL-012. Read **Chapter 6** and **Chapter 7** completely.
...
1. Measure Q factor: Q = fr / BW&minus;3dB where BW is the &minus;3 dB bandwidth from NanoVNA marker delta function.
