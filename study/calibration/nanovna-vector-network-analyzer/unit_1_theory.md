...
**ELOs:** Understand how the instrument performs its primary measurement function; identify key specifications
...
Open TM-INST-018. Read **Chapter 2 — Theory of Operation** completely.
...
**SC1-1.** In one sentence, state the operating principle of the NANOVNA VECTOR NETWORK ANALYZER CALIBRATION OVERVIEW as described in Chapter 2.
...
- The operating principle of the NANOVNA VECTOR NETWORK ANALYZER CALIBRATION OVERVIEW
