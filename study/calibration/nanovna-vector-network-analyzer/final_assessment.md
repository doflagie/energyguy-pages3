# Final Assessment — NANOVNA VECTOR NETWORK ANALYZER CALIBRATION OVERVIEW
**[TM-INST-018 — Open Handout](../../calibration/nanovna-vector-network-analyzer/tm.html)**
**Course:** TM-INST-018
**Questions:** 15 | **Time:** 20 minutes | **No notes**
**Passing score:** 13/15 (87%). All calculation questions must be correct.
...
**1.** State the scope of TM-INST-018: what does it cover and for what application?
...
**3.** In one sentence, state the operating principle of the NANOVNA VECTOR NETWORK ANALYZER CALIBRATION OVERVIEW as described in Chapter 2.
...
**8.** The reference value is 50.000 Ω. The instrument reads 50.23 Ω.
(a) Compute the error in Ω.
(b) Compute the error as % of the reference value.
Show your work.

---

**9.** The reference frequency is 10.000 MHz. The instrument reads 10,000,450 Hz.
(a) Compute the error in Hz.
(b) Compute the error in ppm.
Show your work.
...
**13.** The reference value is 100.0 mV. Your instrument reads 99.3 mV.
(a) Compute error in mV.
(b) Compute error as %.
(c) State whether the instrument is reading high or low.
...
**8.**
(a) 50.23 − 50.000 = **+0.23 Ω**
(b) 0.23 / 50.000 × 100 = **+0.46%**
*(TM App. A)*

---

**9.**
(a) 10,000,450 − 10,000,000 = **+450 Hz**
(b) 450 / 10,000,000 × 1,000,000 = **+45 ppm**
*(TM App. A)*
...
(a) 99.3 − 100.0 = **−0.7 mV**
(b) −0.7 / 100.0 × 100 = **−0.7%**
(c) **Low** — negative error means the instrument reads below the true value.
*(TM App. A)*
