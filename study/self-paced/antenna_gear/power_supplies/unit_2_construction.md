...
Open TM-GEAR-013. Read **Chapter 3 — Equipment and Materials** completely.
...
| Component | Linear | SMPS | LiFePO4 Portable |
|---|---|---|---|
| Transformer | 120VAC/18V, 40VA | None (HF stage) | — |
| Filter cap | 20,000 &micro;F 35V | 220 &micro;F 35V (HF) | — |
| Series pass | 4× 2N3055 on heatsink | IRF540 full-bridge | — |
| Controller | LM723 + op-amp error amp | SG3525 or UC3842 | BQ76920 (see TM-GEAR-004) |
| Output voltage | Adjustable 12–15V | Fixed 13.8V | 12.8V nominal |
| Output current | 0–30A | 20A continuous | 50A max (BMS limited) |
| Ripple | <1 mV RMS | <50 mV RMS | Battery (no ripple) |
