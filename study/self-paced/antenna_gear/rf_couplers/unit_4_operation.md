...
**ELOs:** Install and operate the RF DIRECTIONAL COUPLERS — CONSTRUCTION AND CALIBRATION correctly; interpret performance data; compute derived quantities
...
Open TM-GEAR-015. Read **Chapter 5 — Operating Procedures** and **Appendix A** completely.
...
Directional couplers are passive devices; no operational procedure is
...
outputs to the meter or ADC inputs.

- Never exceed the power rating of the coupler (determined by the
 center conductor rating and connector type).
- Do not operate with the VFWD or VREF ports open (floating) — load them
 with ≥50 kΩ (meter input) to prevent undefined voltage states.

---

## Appendix A — Reference Formulas

Bruene toroidal coupler, BN-43-202:
...
For a 1W signal into 50Ω (V_line = sqrt(50) = 7.07V pk):
  At N2=20: V_coupled = 7.07 / 20 = 0.35V pk → after diode: ~0.15V DC
...
State the installation steps you would take to put the RF DIRECTIONAL COUPLERS — CONSTRUCTION AND CALIBRATION in service on a 40m (7.150 MHz) station.
List steps in order.

**P4-2.** From Chapter 5: what installation or setup detail produces the best RF performance
with the RF DIRECTIONAL COUPLERS — CONSTRUCTION AND CALIBRATION? What is the tradeoff if you omit or shortcut that step?
