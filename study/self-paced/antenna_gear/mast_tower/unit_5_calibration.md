...
**ELOs:** Calibrate the MAST AND TOWER — PORTABLE AND FIXED INSTALLATIONS; verify performance against acceptance criteria; complete calibration log
...
Open TM-GEAR-011. Read **Chapter 6 — Calibration** and **Chapter 7 — Verification and Acceptance** completely.
...
1. Measure actual mast height with a measuring tape or laser rangefinder.
 Record height at each clamp position for future reference.
2. Verify guy wire tension: each guy in a set of three should be tensioned
 equally. Use a wire tension gauge; target 10–15% of rated breaking
 strength for operational tension.
3. Plumb verification: with all guys tensioned, measure horizontal offset
 at the top with a plumb line. Must be <1% of mast height.
...
2. All guy wires tensioned and attachment hardware secure (no loose
 turnbuckles, no shackle pins without cotter pins).
3. Wind load calculation completed and documented for the installed configuration
 (mast height, antenna size, design wind speed).
4. Log: date, mast type, height, antenna mounted, guy radius, design
 wind speed, tension measurements, operator.
...
A criterion found in Chapter 6: **15%**. Confirm the exact criterion in the TM.
