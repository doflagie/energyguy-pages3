...
Open TM-INST-003. Read **Chapter 2 — Theory of Operation** completely.
...
**SC1-1.** In one sentence, state the operating principle of the CAPACITANCE METER CALIBRATION OVERVIEW as described in Chapter 2.
...
- The operating principle of the CAPACITANCE METER CALIBRATION OVERVIEW
