...
**ELOs:** Calibrate the MOXON RECTANGLE ANTENNA to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
**P4-1.** The design frequency of the MOXON RECTANGLE ANTENNA is stated in Chapter 1. Using the formula from Appendix A,
