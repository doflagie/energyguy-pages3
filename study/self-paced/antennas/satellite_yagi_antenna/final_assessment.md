# Final Assessment — SATELLITE YAGI ANTENNA
**[TM-ANT-055 — Open Handout](../../../antennas/satellite_yagi_antenna/tm.html)**
**Course:** TM-ANT-055
**Reference:** TM-ANT-055 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the SATELLITE YAGI ANTENNA?
State it in one sentence using technical terms.

**Q2.** Boom-fed yagi with twisted elements or cross-yagi plus phasing harness for right-hand circular polarization (rhcp). Gain
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the SATELLITE YAGI ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the SATELLITE YAGI ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the SATELLITE YAGI ANTENNA?
...
conclude about the SATELLITE YAGI ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-055.*
