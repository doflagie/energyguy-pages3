# Final Assessment — OCTAL LOOP ANTENNA
**[TM-ANT-049 — Open Handout](../../../antennas/octal_loop/tm.html)**
**Course:** TM-ANT-049
**Reference:** TM-ANT-049 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the OCTAL LOOP ANTENNA?
State it in one sentence using technical terms.

**Q2.** Eight-sided (octagonal) full-wave loop producing lower current variation than square loop; low radiation angle. A full-w
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the OCTAL LOOP ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the OCTAL LOOP ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the OCTAL LOOP ANTENNA?
...
conclude about the OCTAL LOOP ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-049.*
...
**A11.** Criterion: 2.0:1 after matching | ____ |. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
