...
**ELOs:** Understand the operating principle of the END-FED ZEPP ANTENNA; identify key electrical characteristics
...
- The operating principle of the END-FED ZEPP ANTENNA
