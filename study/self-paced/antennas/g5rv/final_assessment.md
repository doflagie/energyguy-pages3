# Final Assessment — G5RV MULTIBAND ANTENNA
**[TM-ANT-032 — Open Handout](../../../antennas/g5rv/tm.html)**
**Course:** TM-ANT-032
**Reference:** TM-ANT-032 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the G5RV MULTIBAND ANTENNA?
State it in one sentence using technical terms.

**Q2.** 102-ft dipole with 34-ft open-wire feeder acting as impedance transformer into coax and atu. A dipole radiates because t
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the G5RV MULTIBAND ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the G5RV MULTIBAND ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the G5RV MULTIBAND ANTENNA?
...
conclude about the G5RV MULTIBAND ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-032.*
...
**A11.** Criterion: SWR <2.0:1 after ATU at center frequency. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
