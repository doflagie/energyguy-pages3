# Final Assessment — ACTIVE RECEIVING ANTENNA
**[TM-ANT-009 — Open Handout](../../../antennas/active_receiving/tm.html)**
**Course:** TM-ANT-009
**Reference:** TM-ANT-009 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the ACTIVE RECEIVING ANTENNA?
State it in one sentence using technical terms.

**Q2.** Small loop or whip with integrated low-noise amplifier (lna), broadband 50 ω output. Receive-only antennas exploit direc
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the ACTIVE RECEIVING ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the ACTIVE RECEIVING ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the ACTIVE RECEIVING ANTENNA?
...
conclude about the ACTIVE RECEIVING ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-009.*
