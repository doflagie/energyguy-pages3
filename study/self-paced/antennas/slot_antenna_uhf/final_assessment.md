# Final Assessment — SLOT ANTENNA — UHF 70cm
**[TM-ANT-060 — Open Handout](../../../antennas/slot_antenna_uhf/tm.html)**
**Course:** TM-ANT-060
**Reference:** TM-ANT-060 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the SLOT ANTENNA — UHF 70cm?
State it in one sentence using technical terms.

**Q2.** Slot antenna cut in pcb ground plane; complementary to dipole by babinet's principle; wideband design. Key parameters: 3
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the SLOT ANTENNA — UHF 70cm?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the SLOT ANTENNA — UHF 70cm.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the SLOT ANTENNA — UHF 70cm?
...
conclude about the SLOT ANTENNA — UHF 70cm? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-060.*
...
**A11.** Criterion: 2.0:1 across 430–440 MHz | ____ |. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
