...
**ELOs:** Understand the operating principle of the PHASED ARRAY — 4-ELEMENT; identify key electrical characteristics
...
Open TM-ANT-053. Read **Chapter 2 — Theory of Operation** completely.
...
Four dipoles in square arrangement with 1λ spacing; phase steering via switched coaxial harness for directional patterns. Key parameters: Square 1λ spacing, switchable patterns (broadside, endfire, cardioid); 7–9 dBi on selected heading; system uses PIN diode switching.

### 2-2. RADIATION CHARACTERISTICS

Gain: 7–9 dBi (steerable). Efficiency: 82–93%. Feed impedance: 50 Ω (combined via hybrid divider). The pattern and polarization depend on the specific antenna geometry; consult the NEC2 model for accurate polar plots and gain/elevation data.
...
**SC1-1.** In one sentence, state the operating principle of the PHASED ARRAY — 4-ELEMENT as described in Chapter 2.

**SC1-2.** What determines the resonant frequency of the PHASED ARRAY — 4-ELEMENT? Name the primary physical parameter(s).

**SC1-3.** What feedpoint impedance does Chapter 2 predict for the PHASED ARRAY — 4-ELEMENT in free space? How does that change over real ground?

**SC1-4.** What radiation pattern does the PHASED ARRAY — 4-ELEMENT produce? What are the nulls and maxima directions?
...
- The operating principle of the PHASED ARRAY — 4-ELEMENT
