# Final Assessment — PHASED ARRAY — 4-ELEMENT
**[TM-ANT-053 — Open Handout](../../../antennas/phased_array_of_4/tm.html)**
**Course:** TM-ANT-053
**Reference:** TM-ANT-053 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the PHASED ARRAY — 4-ELEMENT?
State it in one sentence using technical terms.

**Q2.** Four dipoles in square arrangement with 1λ spacing; phase steering via switched coaxial harness for directional patterns
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the PHASED ARRAY — 4-ELEMENT?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the PHASED ARRAY — 4-ELEMENT.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the PHASED ARRAY — 4-ELEMENT?
...
conclude about the PHASED ARRAY — 4-ELEMENT? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-053.*
