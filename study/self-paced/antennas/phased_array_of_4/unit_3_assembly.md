...
Open TM-ANT-053. Read **Chapter 4 — Assembly Procedures** completely.
...
1. Extract all element lengths and spacings from NEC2 model file phased_array_of_4.nec (GW card dimensions). Convert from meters to inches or feet for construction.
