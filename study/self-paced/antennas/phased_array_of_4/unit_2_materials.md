...
Open TM-ANT-053. Read **Chapter 3 — Materials and Construction** completely.
...
| 1 | Feed connector | SO-239 or N-type; 50 Ω (combined via hybrid divider) system |
| 1 | Support hardware | UV-stable; sized for operating environment (wind, ice load) |
| As needed | Feed line | RG-213 or LMR-400; match to feed impedance 50 Ω (combined via hybrid divider) |
...
All critical dimensions are embedded in the NEC2 model wire card (GW) definitions. Extract from phased_array_of_4.nec for precise construction reference.
