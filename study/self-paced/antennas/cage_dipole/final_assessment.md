# Final Assessment — CAGE DIPOLE ANTENNA
**[TM-ANT-011 — Open Handout](../../../antennas/cage_dipole/tm.html)**
**Course:** TM-ANT-011
**Reference:** TM-ANT-011 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the CAGE DIPOLE ANTENNA?
State it in one sentence using technical terms.

**Q2.** Four to six parallel conductors per arm arranged in a cylindrical cage, producing broad bandwidth. A dipole radiates bec
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the CAGE DIPOLE ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the CAGE DIPOLE ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the CAGE DIPOLE ANTENNA?
...
conclude about the CAGE DIPOLE ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-011.*
...
**A11.** Criterion: SWR <1.5:1 at center frequency. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
