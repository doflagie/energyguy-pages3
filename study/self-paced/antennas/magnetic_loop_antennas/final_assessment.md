# Final Assessment — MAGNETIC LOOP ANTENNA
**[TM-ANT-045 — Open Handout](../../../antennas/magnetic_loop_antennas/tm.html)**
**Course:** TM-ANT-045
**Reference:** TM-ANT-045 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the MAGNETIC LOOP ANTENNA?
...
**Q3.** What determines the resonant frequency of the MAGNETIC LOOP ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the MAGNETIC LOOP ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the MAGNETIC LOOP ANTENNA?
...
conclude about the MAGNETIC LOOP ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-045.*
