...
**ELOs:** Calibrate the COMPACT TRAP DIPOLE to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
**P4-1.** The design frequency of the COMPACT TRAP DIPOLE is stated in Chapter 1. Using the formula from Appendix A,
