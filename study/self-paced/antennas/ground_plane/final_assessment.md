# Final Assessment — GROUND PLANE ANTENNA
**[TM-ANT-034 — Open Handout](../../../antennas/ground_plane/tm.html)**
**Course:** TM-ANT-034
**Reference:** TM-ANT-034 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the GROUND PLANE ANTENNA?
State it in one sentence using technical terms.

**Q2.** Quarter-wave vertical radiator above four ground-plane radials drooped 45° to raise feedpoint impedance to 50 ω. A verti
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the GROUND PLANE ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the GROUND PLANE ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the GROUND PLANE ANTENNA?
...
conclude about the GROUND PLANE ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-034.*
