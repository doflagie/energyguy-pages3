...
**ELOs:** Calibrate the DIPOLE CALIBRATION (HOMEBREW) to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
**P4-1.** The design frequency of the DIPOLE CALIBRATION (HOMEBREW) is stated in Chapter 1. Using the formula from Appendix A,
