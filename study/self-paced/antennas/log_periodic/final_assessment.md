# Final Assessment — LOG PERIODIC ANTENNA — VHF
**[TM-ANT-043 — Open Handout](../../../antennas/log_periodic/tm.html)**
**Course:** TM-ANT-043
**Reference:** TM-ANT-043 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the LOG PERIODIC ANTENNA — VHF?
State it in one sentence using technical terms.

**Q2.** Log periodic dipole array with boom-fed transposed element feed; frequency-independent operation. Gain is achieved throu
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the LOG PERIODIC ANTENNA — VHF?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the LOG PERIODIC ANTENNA — VHF.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the LOG PERIODIC ANTENNA — VHF?
...
conclude about the LOG PERIODIC ANTENNA — VHF? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-043.*
...
**A11.** Criterion: 2.0:1 across 50–150 MHz | ____ |. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
