...
**ELOs:** Calibrate the LOG PERIODIC ANTENNA — VHF to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
**P4-1.** The design frequency of the LOG PERIODIC ANTENNA — VHF is stated in Chapter 1. Using the formula from Appendix A,
