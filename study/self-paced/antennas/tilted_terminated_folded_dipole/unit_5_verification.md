...
Open TM-ANT-068. Read **Chapter 7 — Verification** completely.
...
|---|---|---|
| SWR at resonance | < 2.0:1 across design range | ____ |
| Resonant frequency | Within ±1% of design | ____ |
| Feed impedance (R) | As designed (±15%) | ____ |
| Feed reactance (X) | <±10 Ω at resonance | ____ |
| Gain (NEC2 model) | 0 dBi (termination loss ~3 dB) | ____ |
| Efficiency | 50–65% | ____ |

1. Confirm SWR <2.0:1 across design range at center frequency.
2. Verify resonance frequency within ±1% of design center.
3. Confirm impedance real part within 15% of design value.
4. Record results in station log with date, antenna height, and feed line length.
...
Criterion: **SWR <2.0:1 across design range at center frequency**
