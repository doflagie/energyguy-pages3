# Final Assessment — TILTED TERMINATED FOLDED DIPOLE (T2FD)
**[TM-ANT-068 — Open Handout](../../../antennas/tilted_terminated_folded_dipole/tm.html)**
**Course:** TM-ANT-068
**Reference:** TM-ANT-068 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the TILTED TERMINATED FOLDED DIPOLE (T2FD)?
State it in one sentence using technical terms.

**Q2.** Folded dipole tilted 30–45° from horizontal with 600 ω end termination; broadband with both directional and polarization
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the TILTED TERMINATED FOLDED DIPOLE (T2FD)?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the TILTED TERMINATED FOLDED DIPOLE (T2FD).
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the TILTED TERMINATED FOLDED DIPOLE (T2FD)?
...
conclude about the TILTED TERMINATED FOLDED DIPOLE (T2FD)? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-068.*
...
**A11.** Criterion: SWR <2.0:1 across design range at center frequency. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
