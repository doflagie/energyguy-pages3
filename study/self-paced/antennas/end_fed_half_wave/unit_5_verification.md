...
Open TM-ANT-019. Read **Chapter 7 — Verification** completely.
...
|---|---|---|
| SWR at design frequency | < 2.0:1 on harmonics | ____ |
| Common-mode current on coax | Not perceptible at feed end | ____ |
| Gain (NEC2) | 2.1 dBi broadside | ____ |
| Efficiency | 80–93% (transformer loss ~ 0.5 dB) | ____ |
...
Criterion: **2.0:1 on harmonics | ____ |**
