...
**ELOs:** Understand the operating principle of the CROSS-POLARIZED ANTENNA; identify key electrical characteristics
...
Open TM-ANT-014. Read **Chapter 2 — Theory of Operation** completely.
...
Two crossed dipoles with 90° hybrid phasing network to produce circular polarization. Key parameters: 90° phase shift via coaxial phasing harness, suitable for LEO satellite and meteor scatter work.

### 2-2. RADIATION CHARACTERISTICS

Gain: 2.1 dBic (isotropic, circular). Efficiency: 85–95%. Feed impedance: 50 Ω. The pattern and polarization depend on the specific antenna geometry; consult the NEC2 model for accurate polar plots and gain/elevation data.
...
**SC1-1.** In one sentence, state the operating principle of the CROSS-POLARIZED ANTENNA as described in Chapter 2.

**SC1-2.** What determines the resonant frequency of the CROSS-POLARIZED ANTENNA? Name the primary physical parameter(s).

**SC1-3.** What feedpoint impedance does Chapter 2 predict for the CROSS-POLARIZED ANTENNA in free space? How does that change over real ground?

**SC1-4.** What radiation pattern does the CROSS-POLARIZED ANTENNA produce? What are the nulls and maxima directions?
...
- The operating principle of the CROSS-POLARIZED ANTENNA
