...
**ELOs:** Understand the operating principle of the FRAME LOOP RECEIVING/TRANSMITTING ANTENNA; identify key electrical characteristics
...
Open TM-ANT-030. Read **Chapter 2 — Theory of Operation** completely.
...
Most directional receive antennas use a termination resistor (typically 500–900 Ω) to absorb backward-traveling waves and prevent re-radiation from the far end. This resistance determines the F/B ratio and the wave velocity factor along the antenna. 10–20 ft sides, high Q tuned loop, series capacitor for resonance. The termination must be a non-inductive resistor (carbon composition or metal film; not wirewound) mounted in a weatherproof housing.
...
**SC1-1.** In one sentence, state the operating principle of the FRAME LOOP RECEIVING/TRANSMITTING ANTENNA as described in Chapter 2.

**SC1-2.** What determines the resonant frequency of the FRAME LOOP RECEIVING/TRANSMITTING ANTENNA? Name the primary physical parameter(s).

**SC1-3.** What feedpoint impedance does Chapter 2 predict for the FRAME LOOP RECEIVING/TRANSMITTING ANTENNA in free space? How does that change over real ground?

**SC1-4.** What radiation pattern does the FRAME LOOP RECEIVING/TRANSMITTING ANTENNA produce? What are the nulls and maxima directions?
...
- The operating principle of the FRAME LOOP RECEIVING/TRANSMITTING ANTENNA
