# Final Assessment — ELEVATED RADIALS VERTICAL ANTENNA
**[TM-ANT-018 — Open Handout](../../../antennas/elevated_radials/tm.html)**
**Course:** TM-ANT-018
**Reference:** TM-ANT-018 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the ELEVATED RADIALS VERTICAL ANTENNA?
State it in one sentence using technical terms.

**Q2.** Quarter-wave vertical element above resonant elevated radials, eliminating dependence on lossy earth ground. A vertical 
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the ELEVATED RADIALS VERTICAL ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the ELEVATED RADIALS VERTICAL ANTENNA.
...
**Q6.** [Calculation] Using the formula from Appendix A (`L = 234 / fMHz`):
...
**Q7.** [Calculation] Using the formula: `Rr = 36.6 Ω`
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the ELEVATED RADIALS VERTICAL ANTENNA?
...
conclude about the ELEVATED RADIALS VERTICAL ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-018.*
...
**A6.** Formula: `L = 234 / fMHz`. Frequency 10% higher = element 10% shorter. Confirm your result is physically plausible (shorter wire = higher frequency).
*TM ref: App. A*

**A7.** Formula: `Rr = 36.6 Ω`. Show substitution, arithmetic, result with units.
*TM ref: App. A*
