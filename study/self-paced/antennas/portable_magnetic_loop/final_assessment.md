# Final Assessment — PORTABLE MAGNETIC LOOP ANTENNA
**[TM-ANT-054 — Open Handout](../../../antennas/portable_magnetic_loop/tm.html)**
**Course:** TM-ANT-054
**Reference:** TM-ANT-054 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the PORTABLE MAGNETIC LOOP ANTENNA?
State it in one sentence using technical terms.

**Q2.** A magnetic loop (small transmitting loop, STL) is an electrically small resonant circuit. The loop inductance L is tuned
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the PORTABLE MAGNETIC LOOP ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the PORTABLE MAGNETIC LOOP ANTENNA.
...
**Q6.** [Calculation] Using the formula from Appendix A (`L = 0.002D[ln(4D/d) &minus; 2] (D, d in cm)`):
...
**Q7.** [Calculation] Using the formula: `C = 1/(4π²f²L) (μF when L in μH, f in MHz)`
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the PORTABLE MAGNETIC LOOP ANTENNA?
...
conclude about the PORTABLE MAGNETIC LOOP ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-054.*
...
**A6.** Formula: `L = 0.002D[ln(4D/d) &minus; 2] (D, d in cm)`. Frequency 10% higher = element 10% shorter. Confirm your result is physically plausible (shorter wire = higher frequency).
*TM ref: App. A*

**A7.** Formula: `C = 1/(4π²f²L) (μF when L in μH, f in MHz)`. Show substitution, arithmetic, result with units.
*TM ref: App. A*
