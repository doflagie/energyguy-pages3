# Final Assessment — FOLDED DIPOLE ANTENNA
**[TM-ANT-027 — Open Handout](../../../antennas/folded_dipole/tm.html)**
**Course:** TM-ANT-027
**Reference:** TM-ANT-027 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the FOLDED DIPOLE ANTENNA?
State it in one sentence using technical terms.

**Q2.** Standard folded dipole: two parallel conductors shorted at both ends, fed at center of one conductor. A dipole radiates 
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the FOLDED DIPOLE ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the FOLDED DIPOLE ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the FOLDED DIPOLE ANTENNA?
...
conclude about the FOLDED DIPOLE ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-027.*
...
**A11.** Criterion: SWR <1.5:1 after matching at center frequency. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
