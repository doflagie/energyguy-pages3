# Final Assessment — EXTENDED DOUBLE ZEPP (EDZ) ANTENNA
**[TM-ANT-023 — Open Handout](../../../antennas/extended_double_zepp/tm.html)**
**Course:** TM-ANT-023
**Reference:** TM-ANT-023 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the EXTENDED DOUBLE ZEPP (EDZ) ANTENNA?
State it in one sentence using technical terms.

**Q2.** Dipole with each arm extended to 0.625λ (1.25λ total), increasing broadside gain by ~2 db over standard dipole. A dipole
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the EXTENDED DOUBLE ZEPP (EDZ) ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the EXTENDED DOUBLE ZEPP (EDZ) ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the EXTENDED DOUBLE ZEPP (EDZ) ANTENNA?
...
conclude about the EXTENDED DOUBLE ZEPP (EDZ) ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-023.*
...
**A11.** Criterion: SWR <2.0:1 after matching at center frequency. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
