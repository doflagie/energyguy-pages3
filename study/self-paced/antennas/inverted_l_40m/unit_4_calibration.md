...
**ELOs:** Calibrate the INVERTED-L ANTENNA — 40M to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
**P4-1.** The design frequency of the INVERTED-L ANTENNA — 40M is stated in Chapter 1. Using the formula from Appendix A,
