# Final Assessment — FULL-WAVE LOOP ANTENNA
**[TM-ANT-031 — Open Handout](../../../antennas/full_wave_loop/tm.html)**
**Course:** TM-ANT-031
**Reference:** TM-ANT-031 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the FULL-WAVE LOOP ANTENNA?
State it in one sentence using technical terms.

**Q2.** Full-wavelength closed loop (any shape: square, circle, triangle) fed at one point; inherently low radiation angle. A fu
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the FULL-WAVE LOOP ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the FULL-WAVE LOOP ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the FULL-WAVE LOOP ANTENNA?
...
conclude about the FULL-WAVE LOOP ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-031.*
