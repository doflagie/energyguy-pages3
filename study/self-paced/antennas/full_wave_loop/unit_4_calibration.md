...
**ELOs:** Calibrate the FULL-WAVE LOOP ANTENNA to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-031. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
**P4-1.** The design frequency of the FULL-WAVE LOOP ANTENNA is stated in Chapter 1. Using the formula from Appendix A,
