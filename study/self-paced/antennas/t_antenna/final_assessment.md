# Final Assessment — T-ANTENNA (INVERTED-T)
**[TM-ANT-061 — Open Handout](../../../antennas/t_antenna/tm.html)**
**Course:** TM-ANT-061
**Reference:** TM-ANT-061 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the T-ANTENNA (INVERTED-T)?
State it in one sentence using technical terms.

**Q2.** Short vertical element with horizontal top-loading sections in both directions; capacitive loading increases effective e
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the T-ANTENNA (INVERTED-T)?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the T-ANTENNA (INVERTED-T).
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the T-ANTENNA (INVERTED-T)?
...
conclude about the T-ANTENNA (INVERTED-T)? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-061.*
