# Final Assessment — LOADED VERTICAL HF ANTENNA
**[TM-ANT-042 — Open Handout](../../../antennas/loaded_vertical_hf/tm.html)**
**Course:** TM-ANT-042
**Reference:** TM-ANT-042 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the LOADED VERTICAL HF ANTENNA?
State it in one sentence using technical terms.

**Q2.** Short vertical radiator with series loading coil at center or top to restore electrical length to λ/4. A vertical radiat
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the LOADED VERTICAL HF ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the LOADED VERTICAL HF ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the LOADED VERTICAL HF ANTENNA?
...
conclude about the LOADED VERTICAL HF ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-042.*
