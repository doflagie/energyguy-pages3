...
**ELOs:** Understand the operating principle of the LOADED VERTICAL HF ANTENNA; identify key electrical characteristics
...
Open TM-ANT-042. Read **Chapter 2 — Theory of Operation** completely.
...
**SC1-1.** In one sentence, state the operating principle of the LOADED VERTICAL HF ANTENNA as described in Chapter 2.

**SC1-2.** What determines the resonant frequency of the LOADED VERTICAL HF ANTENNA? Name the primary physical parameter(s).

**SC1-3.** What feedpoint impedance does Chapter 2 predict for the LOADED VERTICAL HF ANTENNA in free space? How does that change over real ground?

**SC1-4.** What radiation pattern does the LOADED VERTICAL HF ANTENNA produce? What are the nulls and maxima directions?
...
- The operating principle of the LOADED VERTICAL HF ANTENNA
