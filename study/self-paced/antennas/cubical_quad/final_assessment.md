# Final Assessment — CUBICAL QUAD ANTENNA
**[TM-ANT-015 — Open Handout](../../../antennas/cubical_quad/tm.html)**
**Course:** TM-ANT-015
**Reference:** TM-ANT-015 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the CUBICAL QUAD ANTENNA?
State it in one sentence using technical terms.

**Q2.** Square full-wave loop driven element with square reflector loop, optional director loops for gain. A full-wave loop fed 
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the CUBICAL QUAD ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the CUBICAL QUAD ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the CUBICAL QUAD ANTENNA?
...
conclude about the CUBICAL QUAD ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-015.*
...
**A11.** Criterion: 1.5:1 after balun | ____ |. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
