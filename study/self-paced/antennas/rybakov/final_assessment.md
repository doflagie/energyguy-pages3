# Final Assessment — RYBAKOV CALIBRATION (HOMEBREW)
**[TM-ANT-006 — Open Handout](../../../antennas/rybakov/tm.html)**
**Course:** TM-ANT-006
**Reference:** TM-ANT-006 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the RYBAKOV CALIBRATION (HOMEBREW)?
State it in one sentence using technical terms.

**Q2.** Calibration compares the Rybakov response to a known reference. For antennas, the reference comes from physical dimensio
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the RYBAKOV CALIBRATION (HOMEBREW)?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the RYBAKOV CALIBRATION (HOMEBREW).
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the RYBAKOV CALIBRATION (HOMEBREW)?
...
conclude about the RYBAKOV CALIBRATION (HOMEBREW)? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-006.*
