# Final Assessment — YAGI-UDA DIRECTIONAL ANTENNA
**[TM-ANT-073 — Open Handout](../../../antennas/yagi_uda/tm.html)**
**Course:** TM-ANT-073
**Reference:** TM-ANT-073 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the YAGI-UDA DIRECTIONAL ANTENNA?
State it in one sentence using technical terms.

**Q2.** Driven element with parasitic reflector and one or more directors providing forward gain; boom-mounted. Gain is achieved
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the YAGI-UDA DIRECTIONAL ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the YAGI-UDA DIRECTIONAL ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the YAGI-UDA DIRECTIONAL ANTENNA?
...
conclude about the YAGI-UDA DIRECTIONAL ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-073.*
