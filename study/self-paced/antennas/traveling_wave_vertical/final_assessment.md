# Final Assessment — TRAVELING WAVE VERTICAL ANTENNA
**[TM-ANT-070 — Open Handout](../../../antennas/traveling_wave_vertical/tm.html)**
**Course:** TM-ANT-070
**Reference:** TM-ANT-070 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the TRAVELING WAVE VERTICAL ANTENNA?
State it in one sentence using technical terms.

**Q2.** Long non-resonant vertical wire with 600 ω resistive termination at the base; traveling wave mode produces flat swr. A v
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the TRAVELING WAVE VERTICAL ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the TRAVELING WAVE VERTICAL ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the TRAVELING WAVE VERTICAL ANTENNA?
...
conclude about the TRAVELING WAVE VERTICAL ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-070.*
...
**A11.** Criterion: 2.0:1 across 1. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
