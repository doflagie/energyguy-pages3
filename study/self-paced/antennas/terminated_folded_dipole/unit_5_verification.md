...
Open TM-ANT-066. Read **Chapter 7 — Verification** completely.
...
|---|---|---|
| SWR at resonance | < 2.0:1 across 7–30 MHz | ____ |
| Resonant frequency | Within ±1% of design | ____ |
| Feed impedance (R) | As designed (±15%) | ____ |
| Feed reactance (X) | <±10 Ω at resonance | ____ |
| Gain (NEC2 model) | 0 dBi (efficiency reduced by termination) | ____ |
| Efficiency | 50–65% (termination loss fundamental) | ____ |

1. Confirm SWR <2.0:1 across 7–30 MHz at center frequency.
...
Criterion: **SWR <2.0:1 across 7–30 MHz at center frequency**
