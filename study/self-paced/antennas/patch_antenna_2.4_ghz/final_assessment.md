# Final Assessment — PATCH ANTENNA — 2.4 GHz
**[TM-ANT-051 — Open Handout](../../../antennas/patch_antenna_2.4_ghz/tm.html)**
**Course:** TM-ANT-051
**Reference:** TM-ANT-051 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the PATCH ANTENNA — 2.4 GHz?
State it in one sentence using technical terms.

**Q2.** Rectangular conducting patch on fr4 dielectric substrate, resonant at patch length ~λ/2 in substrate; microstrip feed. K
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the PATCH ANTENNA — 2.4 GHz?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the PATCH ANTENNA — 2.4 GHz.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the PATCH ANTENNA — 2.4 GHz?
...
conclude about the PATCH ANTENNA — 2.4 GHz? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-051.*
