# Final Assessment — K9AY LOOP ANTENNA — 40M
**[TM-ANT-040 — Open Handout](../../../antennas/k9ay_loop_40m/tm.html)**
**Course:** TM-ANT-040
**Reference:** TM-ANT-040 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the K9AY LOOP ANTENNA — 40M?
State it in one sentence using technical terms.

**Q2.** Tuned receiving loop with resistive termination at one point to produce cardioid directional pattern; bidirectional via 
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the K9AY LOOP ANTENNA — 40M?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the K9AY LOOP ANTENNA — 40M.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the K9AY LOOP ANTENNA — 40M?
...
conclude about the K9AY LOOP ANTENNA — 40M? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-040.*
