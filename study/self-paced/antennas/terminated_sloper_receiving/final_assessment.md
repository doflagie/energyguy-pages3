# Final Assessment — TERMINATED SLOPER RECEIVING ANTENNA
**[TM-ANT-067 — Open Handout](../../../antennas/terminated_sloper_receiving/tm.html)**
**Course:** TM-ANT-067
**Reference:** TM-ANT-067 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the TERMINATED SLOPER RECEIVING ANTENNA?
State it in one sentence using technical terms.

**Q2.** Long sloped wire with resistive termination at far end producing traveling-wave cardioid directional receive pattern. Re
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the TERMINATED SLOPER RECEIVING ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the TERMINATED SLOPER RECEIVING ANTENNA.
...
**Q6.** [Calculation] Using the formula from Appendix A (`v = c / &radic;(1 + (60σ/f)) where σ = ground conductivity (S/m), f in Hz`):
...
**Q7.** [Calculation] Using the formula: `NFant = 10 log10(Tsky/290) (always negative for external-noise-dominated HF)`
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the TERMINATED SLOPER RECEIVING ANTENNA?
...
conclude about the TERMINATED SLOPER RECEIVING ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-067.*
...
**A6.** Formula: `v = c / &radic;(1 + (60σ/f)) where σ = ground conductivity (S/m), f in Hz`. Frequency 10% higher = element 10% shorter. Confirm your result is physically plausible (shorter wire = higher frequency).
*TM ref: App. A*

**A7.** Formula: `NFant = 10 log10(Tsky/290) (always negative for external-noise-dominated HF)`. Show substitution, arithmetic, result with units.
*TM ref: App. A*
...
**A11.** Criterion: 1.5:1 | ____ |. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
