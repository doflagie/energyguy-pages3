# Final Assessment — J-POLE ANTENNA
**[TM-ANT-039 — Open Handout](../../../antennas/j_pole/tm.html)**
**Course:** TM-ANT-039
**Reference:** TM-ANT-039 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the J-POLE ANTENNA?
State it in one sentence using technical terms.

**Q2.** End-fed half-wave radiator with quarter-wave parallel-line matching stub providing 50 ω match at the feedpoint. A vertic
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the J-POLE ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the J-POLE ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the J-POLE ANTENNA?
...
conclude about the J-POLE ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-039.*
