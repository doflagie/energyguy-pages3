# Final Assessment — TAPE ANTENNAS
**[TM-ANT-062 — Open Handout](../../../antennas/tape_antennas/tm.html)**
**Course:** TM-ANT-062
**Reference:** TM-ANT-062 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the TAPE ANTENNAS?
State it in one sentence using technical terms.

**Q2.** Flexible copper-tape strip elements formed into antenna shapes; roll-up portability; suitable for improvised or emergenc
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the TAPE ANTENNAS?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the TAPE ANTENNAS.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the TAPE ANTENNAS?
...
conclude about the TAPE ANTENNAS? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-062.*
