# Final Assessment — OCFD / WINDOM ANTENNA
**[TM-ANT-048 — Open Handout](../../../antennas/ocfd_windom/tm.html)**
**Course:** TM-ANT-048
**Reference:** TM-ANT-048 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the OCFD / WINDOM ANTENNA?
State it in one sentence using technical terms.

**Q2.** 102-ft wire dipole fed at 1/3 point (34 ft from one end) via parallel-wire feeder into balanced tuner. A dipole radiates
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the OCFD / WINDOM ANTENNA?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the OCFD / WINDOM ANTENNA.
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the OCFD / WINDOM ANTENNA?
...
conclude about the OCFD / WINDOM ANTENNA? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-048.*
