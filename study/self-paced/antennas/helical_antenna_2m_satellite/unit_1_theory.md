...
**ELOs:** Understand the operating principle of the HELICAL ANTENNA — 2M SATELLITE; identify key electrical characteristics
...
Open TM-ANT-035. Read **Chapter 2 — Theory of Operation** completely.
...
Solenoid helix operating in axial mode: multi-turn helical conductor producing circular polarization and high gain. Key parameters: 3-turn helix, 4.5 in diameter, 4.5 in pitch, ~8 dBic gain, RHCP, 50 Ω direct feed via microstrip transformer.

### 2-2. RADIATION CHARACTERISTICS

Gain: 8 dBic (circular polarization referenced). Efficiency: 85–95%. Feed impedance: 50 Ω (via λ/4 matching strip). The pattern and polarization depend on the specific antenna geometry; consult the NEC2 model for accurate polar plots and gain/elevation data.
...
**SC1-1.** In one sentence, state the operating principle of the HELICAL ANTENNA — 2M SATELLITE as described in Chapter 2.

**SC1-2.** What determines the resonant frequency of the HELICAL ANTENNA — 2M SATELLITE? Name the primary physical parameter(s).

**SC1-3.** What feedpoint impedance does Chapter 2 predict for the HELICAL ANTENNA — 2M SATELLITE in free space? How does that change over real ground?

**SC1-4.** What radiation pattern does the HELICAL ANTENNA — 2M SATELLITE produce? What are the nulls and maxima directions?
...
- The operating principle of the HELICAL ANTENNA — 2M SATELLITE
