# Final Assessment — HELICAL ANTENNA — 2M SATELLITE
**[TM-ANT-035 — Open Handout](../../../antennas/helical_antenna_2m_satellite/tm.html)**
**Course:** TM-ANT-035
**Reference:** TM-ANT-035 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the HELICAL ANTENNA — 2M SATELLITE?
State it in one sentence using technical terms.

**Q2.** Solenoid helix operating in axial mode: multi-turn helical conductor producing circular polarization and high gain. Key 
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the HELICAL ANTENNA — 2M SATELLITE?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the HELICAL ANTENNA — 2M SATELLITE.
...
**Q6.** [Calculation] Using the formula from Appendix A (`λ (m) = 300 / fMHz`):
...
**Q7.** [Calculation] Using the formula: `GdBi = 10 log10(4π × Aeff / λ²) where Aeff = effective aperture (m²)`
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the HELICAL ANTENNA — 2M SATELLITE?
...
conclude about the HELICAL ANTENNA — 2M SATELLITE? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-035.*
...
**A6.** Formula: `λ (m) = 300 / fMHz`. Frequency 10% higher = element 10% shorter. Confirm your result is physically plausible (shorter wire = higher frequency).
*TM ref: App. A*

**A7.** Formula: `GdBi = 10 log10(4π × Aeff / λ²) where Aeff = effective aperture (m²)`. Show substitution, arithmetic, result with units.
*TM ref: App. A*
