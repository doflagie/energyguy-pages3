...
**ELOs:** Calibrate the END-FED QUARTER-WAVE (EFQW) ANTENNA to resonance; tune SWR to within acceptance criteria; apply frequency calculations
...
Open TM-ANT-020. Read **Chapter 5 — Calibration Procedure**, **Chapter 6 — Tuning and Adjustment**, and **Appendix A** completely.
...
**P4-1.** The design frequency of the END-FED QUARTER-WAVE (EFQW) ANTENNA is stated in Chapter 1. Using the formula from Appendix A,
