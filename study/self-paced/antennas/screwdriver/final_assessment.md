# Final Assessment — SCREWDRIVER CALIBRATION (HOMEBREW)
**[TM-ANT-007 — Open Handout](../../../antennas/screwdriver/tm.html)**
**Course:** TM-ANT-007
**Reference:** TM-ANT-007 handout
**Questions:** 15
...
**Q1.** What is the operating principle of the SCREWDRIVER CALIBRATION (HOMEBREW)?
State it in one sentence using technical terms.

**Q2.** Calibration compares the Screwdriver response to a known reference. For antennas, the reference comes from physical dime
Explain the significance of this principle for antenna performance.

**Q3.** What determines the resonant frequency of the SCREWDRIVER CALIBRATION (HOMEBREW)?
Name the primary physical parameter(s) and state whether increasing that parameter raises or lowers resonant frequency.

**Q4.** Chapter 3 specifies particular materials for the SCREWDRIVER CALIBRATION (HOMEBREW).
...
**Q6.** [Calculation] Using the formula from Appendix A (`the primary length formula from Appendix A`):
...
**Q11.** What is the SWR acceptance criterion stated in Chapter 7 for the SCREWDRIVER CALIBRATION (HOMEBREW)?
...
conclude about the SCREWDRIVER CALIBRATION (HOMEBREW)? What can you NOT conclude?
...
*All answers directly verifiable from TM-ANT-007.*
...
**A6.** Formula: `the primary length formula from Appendix A`. Frequency 10% higher = element 10% shorter. Confirm your result is physically plausible (shorter wire = higher frequency).
*TM ref: App. A*

**A7.** Formula: `a second formula from Appendix A`. Show substitution, arithmetic, result with units.
*TM ref: App. A*
...
**A11.** Criterion: the SWR criterion stated in Chapter 7. Check your wording against Chapter 7 — numeric value and conditions must match exactly.
*TM ref: Ch. 7*
