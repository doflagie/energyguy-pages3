...
Open TM-CAL-015. Read **Chapter 3 — Materials and Construction** completely.
...
|---|---|---|
| 2 | 150 Ω resistor | 0.1%, 50 mW, metal film (R1, R3 shunt) |
| 1 | 37.4 Ω resistor | 0.1%, 50 mW, metal film (R2 series) |
| 1 | SMA double-ended enclosure | Mini-circuits style, or BNC-BNC barrel with PCB |
| 1 | Small PCB | 50 Ω microstrip or air-wired |
