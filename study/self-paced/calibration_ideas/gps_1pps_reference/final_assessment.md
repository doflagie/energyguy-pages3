# Final Assessment — GPS 1PPS TIMING REFERENCE
...
**1.** State the scope of TM-CAL-002: what does it cover and for what application?
...
**3.** In one sentence, state the operating principle of the GPS 1PPS TIMING REFERENCE as described in Chapter 2.
