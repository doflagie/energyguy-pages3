...
Open TM-CAL-010. Read **Chapter 6** and **Chapter 7** completely.
...
The TM states a verification criterion of: **0.05% confirms both methods are consistent**. Confirm the exact wording in Chapter 7.
