...
Open TM-CAL-007. Read **Chapter 5** and **Appendix A** completely.
...
```
Example: 1.000 V from 2.500 V
R2/(R1+R2) = 0.400; e.g., R1=1.5kΩ, R2=1.0kΩ
```
...
An error criterion found in Chapter 5: **0.2%**. Confirm the exact criterion in the TM.
