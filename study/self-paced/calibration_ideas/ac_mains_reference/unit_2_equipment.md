...
Open TM-CAL-005. Read **Chapter 3 — Materials and Construction** completely.
...
> **WARNING:** All construction involving AC mains connections must be performed by a qualified person with appropriate tools and PPE. Verify mains is de-energized before making any connections.
...
| Voltage divider | 10kΩ / 1kΩ divider on secondary | Reduces to ~0.6V RMS |
