...
Open TM-CAL-014. Read **Chapter 5** and **Appendix A** completely.
...
2. SWR <1.5:1 (|S11| < &minus;14 dB) across full range confirms non-reactive construction.
...
```
Parallel resistance
Rtotal = Reach / N for N equal resistors
```
...
```
SWR from Rload and Z0
SWR = Rload/Z0 if Rload > Z0, else Z0/Rload
```
...
An error criterion found in Chapter 5: **5%**. Confirm the exact criterion in the TM.
