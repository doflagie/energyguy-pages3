...
Open TM-CAL-014. Read **Chapter 3 — Materials and Construction** completely.
...
Ten 500 Ω resistors in parallel = 50 Ω total. Each carries 1/10 of total power. For 25 W load, each resistor handles 2.5 W (rated 5 W). Mount resistors radially from center BNC connector with leads  **NOTE:** Carbon composition resistors have good non-inductance but poor power stability. Metal oxide film is preferred: non-inductive and stable. Avoid wirewound at RF frequencies due to inductance.
