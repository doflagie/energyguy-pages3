...
Open TM-CAL-006. Read **Chapter 3 — Materials and Construction** completely.
...
### 3-1. BILL OF MATERIALS (LT1021-5 VERSION)

| Qty | Item | Value/Spec |
|---|---|---|
| 1 | LT1021CCZ-5 or LT1021BCZ-5 | 5.000 V precision reference, TO-92 or DIP-8 |
| 1 | Voltage regulator | LM7809 or LM317, 9–12 V input |
| 1 | Electrolytic capacitor | 10 μF / 25 V |
| 2 | Ceramic capacitor | 100 nF, C0G/NP0 on reference input and output |
| 1 | Resistor | 1kΩ 0.1%, current limiting for shunt types |
