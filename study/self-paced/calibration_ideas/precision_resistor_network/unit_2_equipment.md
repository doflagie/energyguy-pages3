...
Open TM-CAL-008. Read **Chapter 3 — Materials and Construction** completely.
...
### 3-1. DECADE BOX BILL OF MATERIALS

| Qty | Item | Specification |
|---|---|---|
| 4 | Rotary switch | 12-position, make-before-break, low contact resistance |
| 40 | Metal film resistors | 1 Ω through 10kΩ in decade steps, 0.1% |
