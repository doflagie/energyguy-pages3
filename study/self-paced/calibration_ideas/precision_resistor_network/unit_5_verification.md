...
Open TM-CAL-008. Read **Chapter 6** and **Chapter 7** completely.
...
> **NOTE:** Decade boxes are not adjustable after construction. Select resistors with measured values closest to nominal at time of assembly. Keep spares for replacement if any resistor drifts.

---

## Chapter 7 — Verification

1. Verify 1 Ω, 10 Ω, 100 Ω, 1k Ω, 10k Ω positions against NIST-certified reference resistors if available.
2. For everyday use: compare to Wheatstone bridge null measurement (TM-CAL-009).
3. Log calibration values; re-check annually.
