...
Open TM-TOOL-005. Read **Chapter 3 — Equipment and Materials** completely.
...
| Component | Passive | Active | Digital CYD |
|---|---|---|---|
| Detector | 1N34A germanium diode | 1N34A or BAT42 | AD8307 log amp |
| Amplifier | None | BF199 CE + LM386 | Internal to AD8307 |
| Display | 100&micro;A panel meter | 50&micro;A + dB scale | CYD ILI9341 2.8&rdquo; |
| Probe | 50 cm whip, BNC | 50 cm whip, BNC | SMA + 50Ω input |
| Power | None (passive) | 9V battery | 5V USB-C |
