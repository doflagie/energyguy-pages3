# Homebrew Calibration Guide: fluke 15b+ multimeter
...
You have a **fluke 15b+ multimeter** that needs calibration, but:
...
Level 4: Your Equipment
         └─ fluke 15b+ multimeter ← We're here!
```
...
```cpp
/**
 * fluke 15b+ multimeter Calibrator
...
void setup() {
  Serial.begin(115200);
  Serial.println("\nfluke 15b+ multimeter Calibrator Starting...");
...
### Complete Calibration Session: fluke 15b+ multimeter
...
**Overall result:** PASS - fluke 15b+ multimeter calibrated to better than ±0.5%
