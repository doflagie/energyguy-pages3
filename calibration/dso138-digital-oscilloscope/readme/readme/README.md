# Homebrew Calibration Guide: DSO138 digital oscilloscope

**Equipment:** DSO138 digital oscilloscope
...
You have a **DSO138 digital oscilloscope** that needs calibration, but:
...
Level 4: Your Equipment
         └─ DSO138 digital oscilloscope ← We're here!
```
...
```cpp
/**
 * DSO138 digital oscilloscope Calibrator
...
void setup() {
  Serial.begin(115200);
  Serial.println("\nDSO138 digital oscilloscope Calibrator Starting...");
...
### Complete Calibration Session: DSO138 digital oscilloscope
...
**Overall result:** PASS - DSO138 digital oscilloscope calibrated to better than ±0.5%
