# Homebrew Calibration Guide: decade resistance box

**Equipment:** decade resistance box
...
You have a **decade resistance box** that needs calibration, but:
...
Level 4: Your Equipment
         └─ decade resistance box ← We're here!
```
...
```cpp
/**
 * decade resistance box Calibrator
...
void setup() {
  Serial.begin(115200);
  Serial.println("\ndecade resistance box Calibrator Starting...");
...
### Complete Calibration Session: decade resistance box
...
**Overall result:** PASS - decade resistance box calibrated to better than ±0.5%
