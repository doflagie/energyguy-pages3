# dummy load 50 ohm Calibration (Homebrew)

This guide shows a cheap, homebrew way to calibrate a dummy load 50 ohm without any pre-calibrated equipment. It relies on public references (WWV, GPS, AC mains, broadcast carriers) and basic physics.
