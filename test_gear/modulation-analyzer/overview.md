# modulation analyzer Calibration (Homebrew)

This guide shows a cheap, homebrew way to calibrate a modulation analyzer without any pre-calibrated equipment. It relies on public references (WWV, GPS, AC mains, broadcast carriers) and basic physics.
