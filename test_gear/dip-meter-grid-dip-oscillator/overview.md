# dip meter grid dip oscillator Calibration (Homebrew)

This guide shows a cheap, homebrew way to calibrate a dip meter grid dip oscillator without any pre-calibrated equipment. It relies on public references (WWV, GPS, AC mains, broadcast carriers) and basic physics.
