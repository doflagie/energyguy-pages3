# noise figure meter Calibration (Homebrew)

This guide shows a cheap, homebrew way to calibrate a noise figure meter without any pre-calibrated equipment. It relies on public references (WWV, GPS, AC mains, broadcast carriers) and basic physics.
