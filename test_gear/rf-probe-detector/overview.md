# RF probe detector Calibration (Homebrew)

This guide shows a cheap, homebrew way to calibrate a RF probe detector without any pre-calibrated equipment. It relies on public references (WWV, GPS, AC mains, broadcast carriers) and basic physics.
