# decade capacitance box Calibration (Homebrew)

This guide shows a cheap, homebrew way to calibrate a decade capacitance box without any pre-calibrated equipment. It relies on public references (WWV, GPS, AC mains, broadcast carriers) and basic physics.
